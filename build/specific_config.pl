...
sub stratos_config_service {
    ...
    if(defined($stratos_dir)) {
        ...
        $axis2_config_file = $stratos_dir."/repository/conf/axis2.xml";
        ...
        $jmx_config_file = $stratos_dir."/repository/conf/advanced/jmx.xml";
    ...
    if(defined($stratos_target_dir)) {
        ...
        $axis2_config_target_file = $stratos_target_dir."/repository/conf/axis2.xml";
        ...
        $jmx_config_target_file = $stratos_target_dir."/repository/conf/advanced/jmx.xml";
