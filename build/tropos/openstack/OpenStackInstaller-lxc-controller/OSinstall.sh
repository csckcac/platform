...
echo "Configure the /etc/nova/nova.conf file"
...
MYSQL_PRESEED
        echo "Install mysql server from apt"
...
keystone_install() {
	# Configure keystone configs
        echo "Configure keystone configs"
	# Grab from local github repo
...
then
        echo "Install python software properties from apt"
