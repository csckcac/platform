...
public class ThriftEventReceiverServiceImpl implements ThriftEventReceiverService.Iface {
    ...
    public String defineType(String sessionId, String streamDefinition)
            throws ThriftDifferentTypeDefinitionAlreadyDefinedException,
                   ThriftMalformedTypeDefinitionException, ThriftTypeDefinitionException,
                   TException, ThriftSessionExpiredException {
        ...
        return eventDispatcher.defineType(streamDefinition, agentSession);
    }
