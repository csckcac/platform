...
public class ReceiverConfiguration {
    ...
    public boolean equals(Object o) {
        ...
        if (authenticatorPort != that.authenticatorPort) {
            return false;
        }
        if (eventReceiverPort != that.eventReceiverPort) {
            return false;
        }
        if (authenticatorIp != null ? !authenticatorIp.equals(that.authenticatorIp) : that.authenticatorIp != null) {
            return false;
        }
        if (eventReceiverIp != null ? !eventReceiverIp.equals(that.eventReceiverIp) : that.eventReceiverIp != null) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (eventReceiverIp != null ? eventReceiverIp.hashCode() : 0);
        result = 31 * result + eventReceiverPort;
        result = 31 * result + (authenticatorIp != null ? authenticatorIp.hashCode() : 0);
        result = 31 * result + authenticatorPort;
        return result;
    }
}
