...
WSRequest._tunnelcallback = function (thisRequest) {
    ...
    if (httpstatus == '200' || httpstatus == '202') {
        ...
        if (thisRequest._xmlhttp.responseText.indexOf("INVALID_INPUT_EXCEPTION")>-1) {
            thisRequest.error = new WebServiceError("Error occurred due to the invalid input value");
        }
        else {
