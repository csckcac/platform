...
public class APIManagerFactory {
    ...
    private APIManagerCache<APIProvider> providers = new APIManagerCache<APIProvider>(100);
    private APIManagerCache<APIConsumer> consumers = new APIManagerCache<APIConsumer>(100);
