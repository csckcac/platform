...
import org.wso2.carbon.appfactory.user.registration.services.UserRegistrationService;
 ...
 */
public class UserRegistrationServiceImpl extends AbstractAdmin
        implements UserRegistrationService {
    private static final Log log = LogFactory.getLog(UserRegistrationServiceImpl.class);
    public static final String USER_VALIDATION_KEY_PATH = "org.wso2.carbon.appfactory.user" +
                                                          ".registration-validation-key";
    public static final String USER_VALIDATION_CONFIRMATION_FLAG_PATH =
            "org.wso2.carbon.appfactory.user" + ".registration-validation-confirmation-flag";
    ...
    public boolean activateUser(String confirmationKey, String userName, String email)
        ...
        String userValidationKeyPath = this.USER_VALIDATION_KEY_PATH +
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                String msg = "Confirmation key not found for " + userName;
                log.debug(msg);
            }
            return false;
        ...
        try {
            ...
            handleException("Error while adding resorce to registry", e);
        }
    ...
    private Registry getSuperTenantRegistry() throws UserRegistrationException {
        Registry superTenantRegistry = null;
