 ...
 */
public class AppFactoryTenantManager extends JDBCTenantManager {
...
//                LDAPConstants.USER_CONTEXT_NAME, initialDirContext);
        ...
        if (("true").equals(realmConfig.getUserStoreProperty(
            ...
            System.out.println(" sssssssssss  Membership attribute is " + dnOfUserEntry);
    ...
    private String getAdminEntryDN(String dnOfUserContext, Tenant tenant, DirContext initialDirContext)
        ...
        try {
            ...
            System.out.println("******* Setting the userDN " + userDN);
    ...
    private void createAdminGroup(String dnOfGroupContext, String adminUserDN, DirContext initialDirContext)
        ...
        System.out.println("*************   Membership attribute is " + adminUserDN);
