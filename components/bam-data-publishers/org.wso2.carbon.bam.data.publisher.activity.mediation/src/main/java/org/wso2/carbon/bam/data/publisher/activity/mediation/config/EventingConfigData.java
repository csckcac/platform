...
public class EventingConfigData {
    ...
    private static final Log log = LogFactory.getLog(EventingConfigData.class);
    ...
    public void setMsgFlush(String msgFlush) {
        this.msgFlush = msgFlush;
    }

    public String getMsgFlush() {
        return msgFlush;
    }
}