...
import org.wso2.carbon.bam.lwevent.core.builders.GetStatusCommandBuilder;
import org.wso2.carbon.bam.lwevent.core.builders.GetSubscriptionsCommandBuilder;
import org.wso2.carbon.bam.lwevent.core.builders.RenewCommandBuilder;
import org.wso2.carbon.bam.lwevent.core.builders.SubscribeCommandBuilder;
import org.wso2.carbon.bam.lwevent.core.builders.UnSubscribeCommandBuilder;
            ...
            if (subscription != null) {
                ...
                if (subscription.getEventSinkURL().startsWith("sqs://")){
                    ...
                    subscription.setEventDispatcherName(EventBrokerConstants.WS_EVENT_DISPATCHER_NAME);
                              ...
                              String subID = LightWeightEventBroker.getInstance().subscribe(subscription);
