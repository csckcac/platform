...
import org.wso2.carbon.bam.services.stub.authenticationadminservice203.AuthenticationAdminServiceStub;
...
public class AuthenticationAdminClient_2_0_3 extends AbstractAdminClient<AuthenticationAdminServiceStub> {
    private static Log log = LogFactory.getLog(AuthenticationAdminClient_2_0_3.class);
