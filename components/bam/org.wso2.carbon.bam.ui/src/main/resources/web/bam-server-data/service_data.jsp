...
<%
    ...
    String[][] colorsGraphB = {{"c78d15","Request"},{"b06a5c","Response"},{"e23124","Fault"}};

%>
    <%
        String jspname="server_data";
    %>
<style type="text/css">
...
<script type="text/javascript">
    ...
    var sUrl = '../bam-server-data/get_server_data_ajaxprocessor.jsp'
...
<div id="treeData" style="padding-top:100px;">
</div>

<div id="serverDataLegend" class="legendBox">
<%--
    <div class="legendBox-head"><a style="cursor:pointer;" onclick="toggleLegend(this)">Hide Legend<img src="images/up.png" alt="Toggle Legend" align="top" hspace="5"/></a></div>
--%>
    ...
    <table cellpadding="0" cellspacing="0" class="noBorders">
        <tr>
            ...
            <%
                for(int i=0;i<colorsTree.length;i++){
            %>
            <div class="legendBox-out"><div class="legendBox-label"><%=colorsTree[i][1]%></div><div class="legendBox-color" style="background-color:#<%=colorsTree[i][0]%>"></div> </div>
            <% } %>
            </td>
        </tr>
        <tr>
            <td class="legendBox-box" style="vertical-align:bottom !important;width:325px;">
            <div class="legendBox-label-big"><fmt:message key="message.counts"/></div>
            <%
                for(int i=0;i<colorsGraphB.length;i++){
            %>
            <div class="legendBox-out"><div class="legendBox-label"><%=colorsGraphB[i][1]%></div><div class="legendBox-color" style="background-color:#<%=colorsGraphB[i][0]%>"></div> </div>
            <% } %>
            </td>
            <td class="legendBox-box" style="vertical-align:bottom !important;width:265px;">
            <div class="legendBox-label-big"><fmt:message key="response.time"/></div>
            <%
                for(int i=0;i<colorsGraphA.length;i++){
            %>
