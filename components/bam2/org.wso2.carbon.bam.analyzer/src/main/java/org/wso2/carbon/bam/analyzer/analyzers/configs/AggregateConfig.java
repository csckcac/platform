 ...
 */
public class AggregateConfig implements AnalyzerConfig {
    private List<AggregationMeasure> measures;

    public List<AggregationMeasure> getMeasures() {
        return measures;
    }

    public void setMeasures(List<AggregationMeasure> measures) {
