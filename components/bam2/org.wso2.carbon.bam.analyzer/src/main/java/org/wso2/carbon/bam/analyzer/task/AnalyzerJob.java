...
public class AnalyzerJob implements StatefulJob {
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        DataContext dataContext = (DataContext) mergedJobDataMap.get(
                AnalyzerConfigConstants.DATA_CONTEXT);
        AnalyzerSequence analyzerSequence = (AnalyzerSequence) mergedJobDataMap.get(
