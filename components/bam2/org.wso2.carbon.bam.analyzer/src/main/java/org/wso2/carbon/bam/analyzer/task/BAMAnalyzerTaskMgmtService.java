...
public class BAMAnalyzerTaskMgmtService implements TaskManagementService{

    private static final Log log = LogFactory.getLog(BAMAnalyzerTaskMgmtService.class);
    ...
    public BAMAnalyzerTaskMgmtService(ConfigurationContext configurationContext) {
        this.schedulingManager = TaskSchedulingManager.getInstance();
        this.configurationContext = configurationContext;
    }

    private static BAMAnalyzerTaskMgmtService instance = null;
...
/*    public static synchronized BAMAnalyzerTaskMgmtService getInstance() {
    ...
    public void shutdown() {
        schedulingManager.shutDown(configurationContext);
    }
    ...
    public void addTaskDescription(TaskDescription taskDescription, Map<String, Object> resources)
        ...
        try {
            schedulingManager.scheduleTask(taskDescription, resources, configurationContext);
        } catch (Exception e) {
    ...
    public void deleteTaskDescription(TaskDescription taskDescription) {
        ...
        try {
            schedulingManager.deleteTaskDescription(taskDescription, configurationContext);
        } catch (Exception e) {
    ...
    public void editTaskDescription(TaskDescription taskDescription) {
        ...
        if (schedulingManager.isContains(taskDescription.getName(), configurationContext)) {
            schedulingManager.deleteTaskDescription(taskDescription, configurationContext);
            schedulingManager.scheduleTask(taskDescription, null, configurationContext);
        } else {
    ...
    public TaskDescription getTaskDescription(String taskName) {
        return schedulingManager.getTaskDescription(taskName, configurationContext);
    }

    public boolean isContains(String taskName) {
        return schedulingManager.isContains(taskName, configurationContext);
    }
    ...
    private synchronized TaskManager getTaskManager() {
        return (TaskManager) configurationContext.getProperty(
