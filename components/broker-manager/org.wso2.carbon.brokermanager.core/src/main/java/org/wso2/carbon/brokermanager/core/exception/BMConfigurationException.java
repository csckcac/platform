...
public class BMConfigurationException extends Exception {
    ...
    public BMConfigurationException(String message) {
        super(message);
    }

    public BMConfigurationException(String message, Throwable cause) {
        super(message, cause);
    }

    public BMConfigurationException(Throwable cause) {
        super(cause);
    }
}
