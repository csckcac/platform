...
public class BrokerEventProcessingException extends Exception {
    ...
    public BrokerEventProcessingException(String message) {
        super(message);
    }

    public BrokerEventProcessingException(String message, Throwable cause) {
        super(message, cause);
    }

    public BrokerEventProcessingException(Throwable cause) {
        super(cause);
    }
}
