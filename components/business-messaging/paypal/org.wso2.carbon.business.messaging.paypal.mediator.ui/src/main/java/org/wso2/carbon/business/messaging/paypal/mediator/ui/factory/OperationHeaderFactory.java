...
import org.wso2.carbon.business.messaging.paypal.mediator.ui.RequestCredential;
import org.wso2.carbon.business.messaging.paypal.mediator.ui.handler.CredentialHandler;
...
public class OperationHeaderFactory {
     ...
     */
    public static OperationHeaderFactory getInstance() {
     ...
     *
     * @param requestCredential the request credentials for invoking the operation.
     ...
     * @param childElemNS   the namespace of the child element.
     * @param childElemName the name of the child element.
     * @param key           the optional key used to fetch an input.
