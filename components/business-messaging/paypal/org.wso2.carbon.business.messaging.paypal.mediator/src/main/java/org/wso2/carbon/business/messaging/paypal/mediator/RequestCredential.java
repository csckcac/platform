...
public class RequestCredential {
	 ...
	 * @param synCtx
	 *            the synapse context
	 * @param credentialElemName
	 *            the credential element name.
	 * @return the
	 */
	public String evaluate(MessageContext synCtx, String credentialElemName) {
		...
		if (null != credentialTokensMap.get(credentialElemName)) {
			sourceObject = credentialTokensMap.get(credentialElemName).stringValueOf(synCtx);
		...
		if (null == sourceObject) {
			log.debug(String.format("Source String : %s evaluates to null", credentialElemName));
		}
		return sourceObject;
	}
	...
	/**
	 * @param authTokenXPath
	 *            the authTokenXPath to set
	 */
	...
	/**
	 * @param hardExpirationXPath
	 *            the hardExpirationXPath to set
	 */
	...
	/**
	 * @param signatureXPath
	 *            the signatureXPath to set
	 */
	...
	/**
	 * @param inputWrapperNameNS
	 *            the inputWrapperNameNS to set
	 */
	...
	/**
	 * @param inputWrapperNameNSPrefix
	 *            the inputWrapperNameNSPrefix to set
	 */
