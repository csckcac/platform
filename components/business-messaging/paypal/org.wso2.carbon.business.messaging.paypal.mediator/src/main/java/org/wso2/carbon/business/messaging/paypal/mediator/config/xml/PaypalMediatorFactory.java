 ...
 * </pre>
 */
public class PaypalMediatorFactory extends AbstractMediatorFactory {
	 ...
	 * implement  #createSpecificMediator  instead
	 * @see
...
//	}
	...
	public RequestCredential createRequestCredential(
		...
		// }
		// if (null ==
		// requestCredentialElement.getAttribute(ATT_NAMESPACE_PREFIX)
		// || null == requestCredentialElement
	 ...
	 */
	@SuppressWarnings("unchecked")
	private List<Output> createOutputs(OMElement outputsElement) {
