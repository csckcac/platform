...
import org.wso2.carbon.business.messaging.paypal.mediator.Output;
import org.wso2.carbon.business.messaging.paypal.mediator.PaypalMediator;
 ...
 * </pre>
 */
public class PaypalMediatorSerializer extends AbstractMediatorSerializer {

/*
* @Deprecated
* this method is derprecated with ESB 3+ releases
* implement  #serializeSpecificMediator instead
* */
...
//		credentialsElem.addAttribute(fac.createOMAttribute("namespace", nullNS,
//				credentials.getNamespace()));
//		credentialsElem.addAttribute(fac.createOMAttribute("ns-prefix", nullNS,
//				credentials.getNamespacePrefix()));
	...
	private OMElement serializeCredentialElement(SynapseXPath xpath, String sourceValue,
	 ...
	 * @return
	 */
	private OMElement serializeOutputs(List<Output> outputs) {
	 ...
	 * @return
	 */
	private OMElement serializeInput(Input input) {
	 ...
	 * @return
	 */
	private OMElement serializeOutput(Output parameter) {
	...
	public String getMediatorClassName() {
		return PaypalMediator.class.getName();
	}
