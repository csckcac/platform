...
public class AttachmentImpl extends ResourceImpl implements Attachment {
     ...
     * @param content
     */
    public AttachmentImpl(String name, String author, String contentType, InputStream content) {
     ...
     * @param content
     */
    public AttachmentImpl(String id, String name, String author, String contentType,
                          InputStream content) {
        super(id, name, author, contentType, content);
    }
}
