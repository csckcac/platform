...
public class ChangeSettings extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (pmItemCount != null && Integer.valueOf(pmItemCount) !=
                bean.getPmDataModel().getPager().getMaximum()) {
        ...
        if (piItemCount != null && Integer.valueOf(piItemCount) !=
                bean.getPiDataModel().getPager().getMaximum()) {
        ...
        if ((piFilterProcessModelOld == null && piFilterProcessModel != null &&
                !piFilterProcessModel.equals("")) || (piFilterProcessModelOld != null &&
                piFilterProcessModel != null && !piFilterProcessModel.equals(piFilterProcessModelOld))) {
        ...
        if ((piFilterStatusOld == null && piFilterStatus != null && !piFilterStatus.equals("")) ||
                (piFilterStatusOld != null && piFilterStatus != null &&
                        !piFilterStatus.equalsIgnoreCase(piFilterStatusOld.getName()))) {
        ...
        if ((pmFilterStatusOld == null && pmFilterStatus != null && !pmFilterStatus.equals("")) ||
                (pmFilterStatusOld != null && pmFilterStatus != null &&
                        !pmFilterStatus.equalsIgnoreCase(pmFilterStatusOld.getName()))) {
