...
public class ActivityExecEvent
     ...
     */
    public ActivityExecEvent(String name, String activityId, ActivityExecStatus status,
                             Calendar date,
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ActivityExecEvent && getName() != null && getStatus() != null
    ...
    public int hashCode() {
        if (getName() != null && getStatus() != null && getProcessInstance() != null) {
            return getName().hashCode() * 7 + getStatus().hashCode() * 13 +
                    getProcessInstance().hashCode() * 17;
        }
