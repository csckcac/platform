...
/**
 * This class represents a flow arrow segment.
 *
 * @author Gregor Latuske
 */
public class HighlightedArrow
	extends Arrow {

	/**
	 * Constructor of FlowArrow.
	 *
	 * @param positions The array of position the arrow is printed through.
	 */
	public HighlightedArrow(Position... positions) {
		super("arrow orange", "hah", positions);
	}
