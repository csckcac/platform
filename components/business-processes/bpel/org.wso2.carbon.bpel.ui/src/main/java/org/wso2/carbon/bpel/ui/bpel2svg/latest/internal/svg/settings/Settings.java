...
public class Settings {
    ...
    public boolean isOmitted(Activity activity) {
        ...
        // PM Step 3
        if (this.pmGranularity >= 3 && (type.equalsIgnoreCase(BPELActivityType.THROW.getName())
        ...
        if (this.pmGranularity >= 4 &&
                (parentType.equalsIgnoreCase(BPELActivityType.COMPENSATION_HANDLER.getName())
        ...
        if (this.pmGranularity >= 5 &&
                (parentType.equalsIgnoreCase(BPELActivityType.CATCH.getName())
        ...
        if (this.pmGranularity >= 6) {
            ...
            if (omitDepth > 0 &&
                    activity.getRoot().getMaxDepth() - activity.getDepth() < omitDepth) {
                return true;
            }
        }
