...
import org.wso2.carbon.bpel.ui.bpel2svg.latest.internal.frontend.model.ListDataModel;
...
public class ProcessInstanceUtil {
    private static Log log = LogFactory.getLog(ProcessInstanceUtil.class);
    ...
    private static SVG generateSVGForProcessInstance(ProcessInstance instance) throws BPIException {
        try {
            ...
            SVG svg = service.getSVG(instance, new Settings());
            return svg;
