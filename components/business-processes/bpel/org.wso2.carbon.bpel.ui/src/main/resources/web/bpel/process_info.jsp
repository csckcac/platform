...
%>
                "<%=entry.getKey()%>" : "<%=entry.getValue().getServiceLocations().getServiceLocation()[0].split("\\?")[0]%>",
<%
        }
    }
%>
            ...
            jQuery("#qos_wsdl").attr("href", partnerLinkURLJSON[partnerLinkName] + "?wsdl");
            jQuery("#qos_wsdl2").attr("href", partnerLinkURLJSON[partnerLinkName] + "?wsdl2");
        });
    }
