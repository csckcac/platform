...
public class CassandraClusterToolsAdminClientException extends RuntimeException {
     ...
     */
    public CassandraClusterToolsAdminClientException(String msg, Log log) {
        super(msg);
        log.error(msg);
    }
     ...
     * @param log       Logger who need to consume message
     */
    public CassandraClusterToolsAdminClientException(String msg, Throwable throwable, Log log) {
        super(msg, throwable);
