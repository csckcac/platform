 ...
 *  under the License.
 */
public class CassandraClusterToolsDataAdminException extends AxisFault {
     ...
     */
    public CassandraClusterToolsDataAdminException(String msg, Log log) {
        super(msg);
        log.error(msg);
    }
     ...
     * @param log       Logger who need to consume message
     */
    public CassandraClusterToolsDataAdminException(String msg, Throwable throwable, Log log) {
        super(msg, throwable);
