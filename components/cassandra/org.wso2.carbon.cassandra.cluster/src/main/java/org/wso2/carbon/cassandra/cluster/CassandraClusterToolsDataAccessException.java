...
public class CassandraClusterToolsDataAccessException extends RuntimeException {
     ...
     */
    public CassandraClusterToolsDataAccessException(String msg, Log log) {
        super(msg);
        log.error(msg);
    }
     ...
     * @param log       Logger who need to consume message
     */
    public CassandraClusterToolsDataAccessException(String msg, Throwable throwable, Log log) {
        super(msg, throwable);
