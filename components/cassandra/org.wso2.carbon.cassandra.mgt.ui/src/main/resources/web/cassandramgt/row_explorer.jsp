...
<fmt:bundle basename="org.wso2.carbon.cassandra.mgt.ui.i18n.Resources">
    ...
    <div id="middle">
    <h2>
        <h2><fmt:message key="cassandra.cf.row"/> : <%=rowID%></h2>
    </h2>
            ...
            <div class="spacer"></div>
                ...
                <%
                    ...
                    if (columnKey != null) {
                        ...
                        columns[0] = cassandraExplorerAdminClient.getColumn(keyspace, columnFamily, rowID, columnKey);
                        if (columns[0] == null) {
                %>
                    ...
                    <script type="text/javascript" charset="utf-8">
                        ...
                        var aDataSet = [
                            ...
                            for (int i = 0; i < columns.length; i++) { %>
                                ['<%=columns[i].getName()%>', '<%=columns[i].getValue()%>', '<%=(new Date(columns[i].getTimeStamp())).toString()%>']
