...
function setExpressionType(type){
    var inlinedTR = document.getElementById("expressionInlined") ;
    var registryTR = document.getElementById("expressionRegistry");
    if(type == 'inline'){
        inlinedTR.style.display = "";
        registryTR.style.display = "none";
    }else{
       inlinedTR.style.display = "none";
       registryTR.style.display = "";
    }
    return true;
}

function setOutputType(type) {
    var ruleScriptKeyTR = document.getElementById("xmlMapping");
    var ruleScriptSourceTR = document.getElementById("elementMapping");
//    var ruleScriptUploadTR = document.getElementById("ruleScriptUploadTR");
    if ('xml' == type) {
        ruleScriptKeyTR.style.display = "";
        ruleScriptSourceTR.style.display = "none";
