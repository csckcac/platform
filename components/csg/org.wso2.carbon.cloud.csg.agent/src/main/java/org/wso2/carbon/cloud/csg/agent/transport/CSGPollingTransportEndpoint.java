 ...
 */
public class CSGPollingTransportEndpoint extends ProtocolEndpoint {

    private Set<EndpointReference> endpointReferences = new HashSet<EndpointReference>();

    private final WorkerPool workerPool;

    private CSGPollingTransportTaskManager taskManager;


    private CSGPollingTransportReceiver receiver;


    public CSGPollingTransportEndpoint(WorkerPool pool, CSGPollingTransportReceiver receiver) {
        this.workerPool = pool;
        this.receiver = receiver;
    }

    public CSGPollingTransportTaskManager getTaskManager() {
        return taskManager;
    }
    ...
    public boolean loadConfiguration(ParameterInclude params) throws AxisFault {
        ...
        taskManager = CSGPollingTransportTaskManagerFactory.createTaskManagerForService(
