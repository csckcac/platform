...
/**
 * <code>CSGServerBean </code> contains some meta information of the server where the CSG_TRANSPORT_NAME
 * component will be deployed. These information are used to authenticate a client when deploying a
 * proxy in CSG_TRANSPORT_NAME agent component.
 */
public class CSGServerBean {
