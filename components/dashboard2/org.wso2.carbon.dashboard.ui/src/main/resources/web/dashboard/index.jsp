...
<%
    ...
    String tenantdomainFromReqVal = "";
    if (tenantdomainFromReq != null) {
        tenantdomainFromReqVal = "@" + tenantdomainFromReq;
    }
...
<div id="link-panel">
    ...
    <%} else if (userLogedIn) { %>
    <ul>
        <li><strong>Signed-in as&nbsp;<%=loggeduser + tenantdomainFromReqVal%>
        </strong></li>
        <li>|</li>
...
<script type="text/javascript"
            src="/gadgets/js/container:open-views:opensearch:rpc:xmlutil:pubsub-2.js?c=1&debug=1&container=default"></script>
<%
} else {
%>
...
<script type="text/javascript">
    var backendHttpsPort = '<%=DashboardUiUtils.getHttpsPort(backendServerURL)%>';
    ...
    var httpServerRoot = '<%=DashboardUiUtils.getHttpServerRoot(backendServerURL, dashboardUtilBean.getBackendHttpPort())%>';
                ...
                <tr>
                    <td height="20">
                        <div class="footer-content">
                            <div class="copyright">&copy; 2008 - 2009 WSO2 Inc. All Rights
                                Reserved.
                            </div>
                        </div>
                    </td>
