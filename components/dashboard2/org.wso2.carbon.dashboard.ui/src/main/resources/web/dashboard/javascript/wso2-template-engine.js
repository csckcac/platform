...
function json2layout(parentJSONElement) {
    ...
    for (var x = 0; x < parentJSONElement.layout.length; x++) {
        ...
        if (currentLayoutElement.type == "gadget") {
            ...
            responseHTML += "<div id=\"gadget-chrome_" + currentLayoutElement.id + "\" class=\"lineitem gadget gadgets-gadget-chrome\" style=\"width:" + currentLayoutElement.width + ";\"><img class='loadingImg' src='images/loading.gif'/></div>";
        }
