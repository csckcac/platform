 ...
 *  under the License.
 */
package org.wso2.carbon.bam.activity.mediation.data.publisher.ui;
...
import org.wso2.carbon.bam.activity.mediation.data.publisher.stub.ActivityPublisherAdminStub;
...
public class ActivityPublisherAdminClient {
    ...
    private static final String BUNDLE = "org.wso2.carbon.bam.activity.mediation.data.publisher.ui.i18n.Resources";
    ...
    public ActivityConfigData getEventingConfigData() throws RemoteException {
        try {
    ...
    public void setEventingConfigData(ActivityConfigData eventingConfigData)
