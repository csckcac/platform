...
public class ActivityPublisherAdmin  extends AbstractAdmin {
    ...
    private RegistryPersistenceManager registryPersistanceManager;

    public ActivityPublisherAdmin() {
        registryPersistanceManager = new RegistryPersistenceManager();
    }

    public void configureEventing(ActivityConfigData eventingConfigData) throws Exception {
