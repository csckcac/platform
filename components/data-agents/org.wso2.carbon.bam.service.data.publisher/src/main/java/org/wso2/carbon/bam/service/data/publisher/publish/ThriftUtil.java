...
public class ThriftUtil {
            ...
            if (sessionId == null) {
                synchronized (ThriftUtil.class) {
                    if (sessionId == null) {
                        ...
                        client.open();
                        sessionId = authClient.authenticate(bamServerInfo.getBamUserName(),
                                                            bamServerInfo.getBamPassword());
                        client.close();
                    }
                }
            }
    ...
    public static TTransport getClient(BAMServerInfo bamServerInfo) {
        try {
            if (client == null) {
                synchronized (ThriftUtil.class) {
                    if (client == null) {
                        ...
                        client = new THttpClient(bamServerInfo.getBamServerURL() +"thriftAuthenticator");
                    }
                }
            }
        } catch (TTransportException e) {
