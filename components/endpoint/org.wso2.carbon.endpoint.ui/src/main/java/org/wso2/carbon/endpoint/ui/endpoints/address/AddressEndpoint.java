...
public class AddressEndpoint extends Endpoint {
    ...
    private void buildData(org.apache.synapse.endpoints.AddressEndpoint addressEndpoint) {
        ...
        setRetryTimeout(String.valueOf(addressEndpoint.getDefinition().getRetryDurationOnTimeout()));
        setRetryDelay(String.valueOf(addressEndpoint.getDefinition().getRetriesOnTimeoutBeforeSuspend()));
