...
public class DefaultEndpoint extends Endpoint {
    ...
    private void buildData(org.apache.synapse.endpoints.DefaultEndpoint defaultEndpoint) {
        ...
        setRetryTimeout(String.valueOf(defaultEndpoint.getDefinition().getRetryDurationOnTimeout()));
        setRetryDelay(String.valueOf(defaultEndpoint.getDefinition().getRetriesOnTimeoutBeforeSuspend()));
