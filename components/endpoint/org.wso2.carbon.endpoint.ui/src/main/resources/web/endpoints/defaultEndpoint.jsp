...
<div id="workArea">
    <form action="updatePages/defaultEndpoint-update.jsp" id="endpoint-editor-form"
        ...
        <table class="styledLeft">
            ...
            <tr>
                <th><span style="float: left; position: relative; margin-top: 2px;">
                    ...
                    <a class="icon-link"
                       ...
                       onclick="switchToSource('Default','<%=isAnonymous%>','<%=isFromTemplateEditor%>');"
            ...
            <tr>
                <td>
                    <div id="endpointForm">
                        <jsp:include page="forms/defaultEndpoint-form.jsp" flush="true">
                            ...
                            <tr>
                                <td class="buttonRow" colspan="2">
                                    <input type="button" value="<fmt:message key="save"/>"
                                           ...
                                           onclick="javascript:submitEndpointData('Default','<%=isAnonymous%>','<%=isFromTemplateEditor%>');"/>
                                    <%
                            ...
                            <tr>
                                <td class="buttonRow">
                                    <input type="button" class="button"
                                           ...
                                           onclick="javascript:submitDynamicEndpointData('Default','<%=isFromTemplateEditor%>'); return false;"/>
                                    <input type="button" class="button"
