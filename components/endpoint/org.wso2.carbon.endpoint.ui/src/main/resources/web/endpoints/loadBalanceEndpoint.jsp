    ...
    <tr>
        <td class="buttonRow">
            <input type="button" value="<fmt:message key="save"/>"
                   class="button"
                   name="save"
                   onclick="submitEndpointData('LoadBalance','<%=isAnonymous%>','false');"/>
            <%
                if (!isAnonymous) {
            %>
        ...
        <tr>
            <td>
                <table class="normal">
                    ...
                    <td><fmt:message key="gov.registry"/> <input type="radio" name="registry"
                                                                 id="gov_reg"
                    ...
                    <tr>
                        ...
                        <td><span id="reg">gov:</span><input type="text" size="75" id="synRegKey"/>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td class="buttonRow">
                <input type="button" class="button" value="<fmt:message key="save"/>"
                       id="saveSynRegButton"
                       onclick="javascript:submitDynamicEndpointData('LoadBalance','false'); return false;"/>
