...
//        serverFactory.setResourceClasses(EventResource.class);
//        serverFactory.setResourceProvider(EventResource.class,
//                new SingletonResourceProvider(new EventResource()));
...
//
//          sf.setServiceBean(new EventResource());
