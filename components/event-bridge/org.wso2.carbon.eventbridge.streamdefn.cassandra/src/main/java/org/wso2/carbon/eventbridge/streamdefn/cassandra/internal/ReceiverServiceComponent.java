...
public class ReceiverServiceComponent {
    ...
    protected void setEngine(Engine engine) {
        Utils.setBamEventSubscriber(new BAMEventSubscriber());
        engine.addEventSubscriber(Utils.getBamEventSubscriber());
    }

    protected void unsetEngine(Engine engine) {
        engine.removeEventSubscriber(Utils.getBamEventSubscriber());
        Utils.setBamEventSubscriber(null);
