...
public class BaseCassandraSDSTest extends AbstractCassandraUnit4TestCase {
    ...
    public static void beforeClass() throws Exception {
        ...
        try {
            streamDefinition1 = StreamDefnConverterUtils.convertFromJson(CassandraTestConstants.definition);
            streamDefinition2 = StreamDefnConverterUtils.convertFromJson(CassandraTestConstants.definition2);
            tooLongStreamDefinition = StreamDefnConverterUtils.convertFromJson(CassandraTestConstants.tooLongdefinition);
            streamDefinition3 = StreamDefnConverterUtils.convertFromJson(CassandraTestConstants.definition3);
