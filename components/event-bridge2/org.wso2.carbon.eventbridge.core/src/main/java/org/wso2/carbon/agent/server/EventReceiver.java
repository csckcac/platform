...
public interface EventReceiver {
     ...
     *
     * @param credentials    the domain name
     * @param streamName    the stream name
     * @param streamVersion the stream version
     * @return Event Stream Definition
     */
    EventStreamDefinition getStreamDefinition(Credentials credentials, String streamName,
     ...
     * @return Event Stream Definition
     */
    EventStreamDefinition getStreamDefinition(Credentials credentials, String streamId)
            throws StreamDefinitionNotFoundException;
     ...
     *
     */
    List<EventStreamDefinition> getAllStreamDefinition(Credentials credentials)
            throws StreamDefinitionNotFoundException;
     ...
     */
    void saveEventStreamDefinition(Credentials credentials, String eventStreamDefinition)
