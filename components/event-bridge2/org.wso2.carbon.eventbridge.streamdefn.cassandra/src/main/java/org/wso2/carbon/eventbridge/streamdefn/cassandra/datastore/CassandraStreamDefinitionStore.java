...
public class CassandraStreamDefinitionStore extends AbstractStreamDefinitionStore {
    ...
    @Override
    protected void saveStreamDefinitionToStore(Credentials credentials, String streamId, EventStreamDefinition eventStreamDefinition) throws StreamDefinitionStoreException {
    ...
    @Override
    public EventStreamDefinition getStreamDefinitionFromStore(Credentials credentials, String streamId)
            throws StreamDefinitionStoreException {
        return cassandraConnector.getStreamDefinitionFromStore(ClusterFactory.getCluster(credentials), streamId);
    }

    @Override
    protected Collection<EventStreamDefinition> getAllStreamDefinitionsFromStore(Credentials credentials) throws
