...
public class CommandBuilderConstants extends CarbonEventBrokerConstants {

    private static final String NULL_NAMESPACE = "";

    public static final QName SUBSCRIBE_QNAME =
            new QName(WSE_EVENTING_NS, WSE_EN_SUBSCRIBE);
    public static final QName DELIVERY_QNAME =
            new QName(WSE_EVENTING_NS, WSE_EN_DELIVERY);
    public static final QName FILTER_QNAME =
            new QName(WSE_EVENTING_NS, WSE_EN_FILTER);
    public static final QName NOTIFY_TO_QNAME =
            new QName(WSE_EVENTING_NS, WSE_EN_NOTIFY_TO);
    public static final QName ATT_DIALECT =
            new QName(NULL_NAMESPACE, WSE_EN_DIALECT);
    public static final QName ATT_XPATH =
            new QName(NULL_NAMESPACE, WSE_EN_XPATH);
    public static final QName IDENTIFIER =
            new QName(WSE_EVENTING_NS, WSE_EN_IDENTIFIER);
    public static final QName EXPIRES =
            new QName(WSE_EVENTING_NS, WSE_EN_EXPIRES);
    public static final QName RENEW =
            new QName(WSE_EVENTING_NS, WSE_EN_RENEW);
}
