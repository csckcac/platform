...
* under the License.
*/
package org.wso2.carbon.gadget.initializer.modules.social.services;
...
import org.wso2.carbon.gadget.initializer.modules.social.utils.SocialUtils;
...
public class GSPersonService implements PersonService {
    ...
    public Future<Person> updatePerson(UserId userId, Person person, SecurityToken securityToken) throws ProtocolException {
        //TODo -  Added in order to fulfill the requirements of the new Person Api of Shindig
