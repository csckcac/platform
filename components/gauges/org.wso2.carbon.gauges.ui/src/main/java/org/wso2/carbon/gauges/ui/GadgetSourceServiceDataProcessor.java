...
import org.wso2.carbon.gauges.ui.governance.gadgetsource.beans.xsd.LifecycleInfoBean;
import org.wso2.carbon.gauges.ui.governance.gadgetsource.beans.xsd.LifecyclePiechartGadgetBean;
import org.wso2.carbon.gauges.ui.governance.gadgetsource.beans.xsd.LifecycleStageInfoBean;
...
public class GadgetSourceServiceDataProcessor {
    ...
    public String getLifeCycles() {
    	...
    	String lifeCycleNames = new String();
    	if (gadgetBean != null) {
    		LifecycleInfoBean[] lifecycles = gadgetBean.getLifecycles();
    		
    		for (int i = 0; i < lifecycles.length; i++) {
    			lifeCycleNames += lifecycles[i].getName() + ";";
    		}
    	}
