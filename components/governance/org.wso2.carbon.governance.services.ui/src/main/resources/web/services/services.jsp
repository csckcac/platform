...
<script type="text/javascript">
    ...
    function initCollapseMenu() {
        ...
        var _hbanners = document.getElementById("#_addTable").getElementsByTagName("tbody")[0].getElementsByTagName("tr")[0].getElementsByTagName("td")[0].getElementsByTagName("div");
