...
<%@ page import="org.wso2.carbon.governance.wsdl.ui.TreeNodeBuilder" %>
...
<%
    if(!CarbonUIUtil.isUserAuthorized(request, "/permission/admin/manage/resources/govern/metadata/list")){
        return;
    }
    ...
    try {
        ...
        treeNodeBuilder.setActualWsdlPath(client.getProperty(path, "registry.actualpath"));
...
<link rel="stylesheet" type="text/css" href="../wsdl/css/treeview.css" />
        <div class="yui-skin-sam">
            ...
            <p style="margin: 10px !important;">
                Click on the <a onclick="viewStandardContentSection('<%=path%>')">Standard view</a> to view, edit, download or <a onclick="visualizeXML('<%=path%>', 'wsdl')">visualize</a> the wsdl.
            </p>
            <br/>
