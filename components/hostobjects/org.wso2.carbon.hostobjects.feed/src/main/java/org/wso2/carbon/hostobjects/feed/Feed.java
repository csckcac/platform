...
public class Feed extends ScriptableObject implements IFeed {
     ...
     * @return E4X XML
     */
    public Scriptable jsGet_XML() throws ScriptException {
    ...
    public static Scriptable jsFunction_writeTo(Context cx, Scriptable thisObj, Object[] arguments,
        ...
        try {
            if (arguments[0] instanceof String) {
                ...
                outputStreamWriter = new OutputStreamWriter(fileHostHostObject.getOutputStream());
                SyndFeedOutput output = new SyndFeedOutput();
                output.output(feedObject.feed, outputStreamWriter);
