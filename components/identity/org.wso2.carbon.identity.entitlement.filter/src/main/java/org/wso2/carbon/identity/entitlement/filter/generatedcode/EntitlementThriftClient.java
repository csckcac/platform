 ...
 */
package org.wso2.carbon.identity.entitlement.filter.generatedcode;
...
public class EntitlementThriftClient {
    ...
    public static class Client extends org.apache.thrift.TServiceClient implements Iface {
        ...
        public void send_getDecision(String request, String sessionId)
                throws org.apache.thrift.TException {
    ...
    public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor
        ...
        private static class getDecision<I extends Iface>
                extends ProcessFunction<I, getDecision_args> {
            public getDecision() {
                super("getDecision");
            }
            ...
            protected getDecision_result getResult(I iface, getDecision_args args)
                    throws org.apache.thrift.TException {
                getDecision_result result = new getDecision_result();
                try {
    ...
    public static class getDecision_args
            implements TBase<getDecision_args, getDecision_args._Fields>, java.io.Serializable,
                       Cloneable {
        ...
        static {
            ...
            tmpMap.put(_Fields.REQUEST, new FieldMetaData("request", org.apache.thrift.TFieldRequirementType.REQUIRED,
                                                          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
            tmpMap.put(_Fields.SESSION_ID, new FieldMetaData("sessionId", org.apache.thrift.TFieldRequirementType.REQUIRED,
                                                             new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    public static class getDecision_result
            implements TBase<getDecision_result, getDecision_result._Fields>, java.io.Serializable,
                       Cloneable {
        ...
        static {
            Map<_Fields, FieldMetaData> tmpMap = new EnumMap<_Fields, FieldMetaData>(_Fields.class);
            tmpMap.put(_Fields.SUCCESS, new FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT,
                                                          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
            tmpMap.put(_Fields.E, new FieldMetaData("e", org.apache.thrift.TFieldRequirementType.DEFAULT,
