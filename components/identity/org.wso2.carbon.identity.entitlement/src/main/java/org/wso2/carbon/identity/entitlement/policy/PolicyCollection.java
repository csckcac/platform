...
public class PolicyCollection {
     ...
     */
    public PolicyCollection(PolicyCombiningAlgorithm combiningAlg, int maxInMemoryPolicies) {
     ...
     */
    public AbstractPolicy getPolicy(ArrayList<AbstractPolicy> policies) throws EntitlementException {
