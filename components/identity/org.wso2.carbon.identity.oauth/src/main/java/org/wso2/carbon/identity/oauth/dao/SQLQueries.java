...
public class SQLQueries {
    ...
    public static class OAuthAppDAOSQLQueries {
        ...
        public static final String ADD_OAUTH_CONSUMER = "INSERT INTO IDENTITY_OAUTH_CONSUMER_APPLICATIONS " +
                "(CONSUMER_KEY, CONSUMER_SECRET, USERNAME, TENANT_ID, OAUTH_VERSION) VALUES (?,?,?,?,?) ";

        public static final String UPDATE_OAUTH_CONSUMER = "UPDATE IDENTITY_OAUTH_CONSUMER_APPLICATIONS " +
        ...
        public static final String GET_APPS_OF_USER = "SELECT CONSUMER_KEY, CONSUMER_SECRET, APP_NAME, OAUTH_VERSION, CALLBACK_URL FROM " +
                "IDENTITY_OAUTH_CONSUMER_APPLICATIONS WHERE USERNAME=? AND TENANT_ID=?";

        public static final String GET_APP_INFO = "SELECT CONSUMER_SECRET, APP_NAME, OAUTH_VERSION, CALLBACK_URL FROM " +
                "IDENTITY_OAUTH_CONSUMER_APPLICATIONS WHERE CONSUMER_KEY=? ";

        public static final String UPDATE_CONSUMER_APP = "UPDATE IDENTITY_OAUTH_CONSUMER_APPLICATIONS SET CALLBACK_URL=? " +
                "WHERE CONSUMER_KEY=? AND CONSUMER_SECRET=?";

        public static final String CHECK_EXISTING_APPLICATION = "SELECT * FROM IDENTITY_OAUTH_CONSUMER_APPLICATIONS " +
                "WHERE USERNAME=? AND TENANT_ID=? AND APP_NAME=?";

        public static final String CHECK_EXISTING_CONSUMER = "SELECT * FROM IDENTITY_OAUTH_CONSUMER_APPLICATIONS " +
                "WHERE CONSUMER_KEY=?";
    ...
    public static class OAuthConsumerDAOSQLQueries {
        ...
        public static final String ADD_OAUTH_REQ_TOKEN = "INSERT INTO IDENTITY_OAUTH1A_REQUEST_TOKEN (REQUEST_TOKEN, REQUEST_TOKEN_SECRET, CONSUMER_KEY, " +
        ...
        public static final String AUTHORIZE_REQ_TOKEN = "UPDATE IDENTITY_OAUTH1A_REQUEST_TOKEN SET AUTHORIZED=?, OAUTH_VERIFIER=?, AUTHZ_USER=? " +
                "WHERE REQUEST_TOKEN=?";
        ...
        public static final String GET_ACCESS_TOKEN = "SELECT SCOPE, AUTHZ_USER FROM IDENTITY_OAUTH1A_ACCESS_TOKEN " +
                "WHERE ACCESS_TOKEN=?";

        public static final String GET_ACCESS_TOKEN_SECRET = "SELECT ACCESS_TOKEN_SECRET FROM IDENTITY_OAUTH1A_ACCESS_TOKEN " +
                "WHERE ACCESS_TOKEN=?";
