 ...
 * under the License.
 */
package org.wso2.carbon.mediator.autoscale.ec2autoscale.replication;
...
public class RequestTokenReplicationCommand extends ClusteringMessage {
    ...
    public void execute(ConfigurationContext configurationContext) throws ClusteringFault {
        ...
        configurationContext.setNonReplicableProperty(AutoscaleConstants.APP_DOMAIN_CONTEXTS,
