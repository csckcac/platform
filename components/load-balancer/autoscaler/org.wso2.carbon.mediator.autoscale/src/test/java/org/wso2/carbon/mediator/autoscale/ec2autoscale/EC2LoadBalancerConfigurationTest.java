...
public class EC2LoadBalancerConfigurationTest extends TestCase {
    ...
    public void testServicesConfig() throws XMLStreamException {
        ...
        LoadBalancerConfiguration.ServiceConfiguration asServiceConfig = ec2LBConfig.getServiceConfig("wso2.as.domain");
        ...
        LoadBalancerConfiguration.ServiceConfiguration dsServiceConfig = ec2LBConfig.getServiceConfig("wso2.ds.domain");
