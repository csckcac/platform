...
public class LocalEntryDeployer extends org.apache.synapse.deployers.LocalEntryDeployer {
    ...
    public String deploySynapseArtifact(OMElement artifactConfig, String fileName,
        ...
        mpm.saveItemToRegistry(entryName, ServiceBusConstants.ITEM_TYPE_ENTRY);
        return entryName;
    }
    ...
    public void undeploySynapseArtifact(String artifactName) {
        ...
        mpm.deleteItemFromRegistry(artifactName, ServiceBusConstants.ITEM_TYPE_ENTRY);
    }

    @Override
    public void restoreSynapseArtifact(String artifactName) {
        super.restoreSynapseArtifact(artifactName);
        mpm.saveItemToRegistry(artifactName, ServiceBusConstants.ITEM_TYPE_ENTRY);
    }
}
