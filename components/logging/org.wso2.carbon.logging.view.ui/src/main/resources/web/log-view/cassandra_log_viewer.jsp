...
// 		LogEvent logs[];
		...
		try {
			...
			events = logViewerClient.getSystemLogs("", "",
								...
								<table class="normal-nopadding" width="100%">
									<tr>
										<td>
											...
											<%
												if (!isDateGiven) {
											%> <input type="radio" name="radioDate" value="Now" checked>Now<br>
											   <input type="radio" name="radioDate"
														value="<%=date+"_"+time%>"><input type="text"
														id="date" name="date" value="<%=date%>" size="8" /> - <input
														type="text" id="time" name="time" value="<%=time%>"
														size="5" /><fmt:message key="date.format" /> <br> <fmt:message key="date.example" /> <br> <%
 										} else {
 										
										 %> <input type="radio" name="radioDate" value="Now"> Now<br>
											<input type="radio" name="radioDate"
														value="<%=date+"_"+time%>" checked><input type="text"
														id="date" name="date" value="<%=date%>" size="8" /> - <input
														type="text" id="time" name="time" value="<%=time%>"
														size="5" /><fmt:message key="date.format" /> <br> <fmt:message key="date.example" /> <br><%
