...
* under the License.
*/
package org.wso2.carbon.mashup.javascript.hostobjects.feed.internal;

import org.wso2.carbon.mashup.javascript.hostobjects.hostobjectservice.service.HostObjectService;


/**
 * @scr.component name="mashup.javascript.hostobjects.feed.dscomponent"" immediate="true"
...
public class FeedServiceComponent {
    ...
    protected void setHostObjectService(HostObjectService hostObjectService) {
        FeedServiceComponent.hostObjectService = hostObjectService;
    }

    protected void unsetHostObjectService(HostObjectService hostObjectService) {
        FeedServiceComponent.hostObjectService = null;
    }

    public static HostObjectService getHostObjectService() {
        return FeedServiceComponent.hostObjectService;
    }
}