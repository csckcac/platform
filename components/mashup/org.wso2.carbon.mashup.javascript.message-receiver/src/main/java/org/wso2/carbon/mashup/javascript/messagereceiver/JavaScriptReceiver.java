...
public class JavaScriptReceiver extends AbstractInOutMessageReceiver implements MessageReceiver {
    ...
    public void invokeBusinessLogic(MessageContext inMessage, MessageContext outMessage)
        ...
        try {
            ...
            Reader reader = MashupUtils.readJS(inMessage.getServiceContext().getAxisService());
            String jsFunctionName = inferJavaScriptFunctionName(inMessage);

            //support for importing javaScript files using the axis2.xml
            ...
            if (xmlSchemaElement != null) {
                ...
                OMElement element;
                String contentType = (String) inMessage.getProperty(
    ...
    /**
     * Provides support for importing JavaScript files specified in
     * the Axis2.xml using the "loadJSScripts" parameter.
     *
    ...
    private String getImportScriptsList(MessageContext inMessage) {
        ...
        Parameter param = inMessage.getConfigurationContext().getAxisConfiguration().getParameter(
                MashupConstants.LOAD_JSSCRIPTS);
        if (param != null) {
    ...
    private String inferJavaScriptFunctionName(MessageContext inMessage) throws AxisFault {
        ...
        if ((parameter = op.getParameter(MashupConstants.JS_FUNCTION_NAME)) != null) {
