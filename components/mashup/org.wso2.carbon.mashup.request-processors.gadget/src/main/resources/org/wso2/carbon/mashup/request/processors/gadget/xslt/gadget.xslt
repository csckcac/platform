...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:import href="/xslt/tryit.xslt"/>
    <xsl:import href="/xslt/mockit.xslt"/>
    ...
    <xsl:template match="service">
        ...
        <Module>
            <ModulePrefs title="Try the {$service} service" width="320" height="240" scrolling="true">
            ...
            <Content type="html">
                ...
                <xsl:variable name="src">
                    <xsl:choose>
                        <xsl:when test="$js-service-stub"><xsl:value-of select="$js-service-stub"/></xsl:when>
