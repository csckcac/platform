...
//    }
    ...
    <div id="middle">
        <h2><fmt:message key="libs.application.dashboard"/> : <%= appName%></h2>
        ...
        <div id="workArea">
            <form action="" name="appInfoForm" method="post">
                ...
                <table class="styledLeft" id="servicesTable" width="60%">
                    <thead>
                    <tr>
                        <th width="50%"><img src="images/service.gif" alt="" style="vertical-align:middle;">&nbsp;<fmt:message key="libs.service.groups"/></th>
                        <th><fmt:message key="libs.services"/></th>
                        <%--<th><fmt:message key="libs.actions"/></th>--%>
                    </tr>
                    </thead>
                    <tbody>
                    <%
                ...
                <table class="styledLeft" id="dataservicesTable" width="60%">
                    <thead>
                    <tr>
                        <th width="50%"><img src="../data_service/images/type.gif" alt="" style="vertical-align:middle;">&nbsp;<fmt:message key="libs.ds.service.groups"/></th>
                        <th><fmt:message key="libs.ds.services"/></th>
                    </tr>
                    </thead>
                    <tbody>
                    <%
                ...
                <table class="styledLeft" id="RegistryArtifactsTable" width="100%">
                    <thead>
                    <tr>
                        <th width="15%"><nobr><fmt:message key="libs.registry.artifact"/></nobr></th>
                        <th width="20%"><fmt:message key="libs.registry.resources"/></th>
                        <th width="20%"><fmt:message key="libs.registry.collections"/></th>
                        <th width="20%"><fmt:message key="libs.registry.dumps"/></th>
                        <th width="25%"><fmt:message key="libs.registry.associations"/></th>
                    </tr>
                    </thead>
                    <tbody>
                    <%
                ...
                <table class="styledLeft" id="RegistryFiltersTable" width="40%">
                    <thead>
                    <tr>
                        <th><img src="images/filter.gif" alt="" style="vertical-align:middle;">&nbsp;<fmt:message key="libs.registry.filters"/></th>
                    </tr>
                    </thead>
                    <tbody>
                    <%
                ...
                <table class="styledLeft" id="RegistryHandlersTable" width="40%">
                    <thead>
                    <tr>
                        <th><img src="images/handler.gif" alt="" style="vertical-align:middle;">&nbsp;<fmt:message key="libs.registry.handlers"/></th>
                    </tr>
                    </thead>
                    <tbody>
                    <%
