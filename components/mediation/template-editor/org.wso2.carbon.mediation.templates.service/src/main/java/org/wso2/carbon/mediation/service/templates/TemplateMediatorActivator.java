...
import org.wso2.carbon.mediation.service.templates.internal.TemplateMediatorService;
import org.wso2.carbon.mediator.service.MediatorService;

import java.util.Properties;

public class TemplateMediatorActivator implements BundleActivator {

    private static final Log log = LogFactory.getLog(TemplateMediatorActivator.class);
    ...
    public void stop(BundleContext bundleContext) throws Exception {
        if (log.isDebugEnabled()) {
            log.debug("Stopped the template mediator service...");
        }
    }
}
