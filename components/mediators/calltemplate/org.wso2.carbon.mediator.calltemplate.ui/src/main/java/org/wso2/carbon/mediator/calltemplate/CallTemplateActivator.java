 ...
 * 
 */
public class CallTemplateActivator implements BundleActivator {

    private static final Log log = LogFactory.getLog(CallTemplateActivator.class);
    ...
    public void stop(BundleContext bundleContext) throws Exception {
        if (log.isDebugEnabled()) {
            log.debug("Stopped the call-template mediator component ...");
        }
    }
}
