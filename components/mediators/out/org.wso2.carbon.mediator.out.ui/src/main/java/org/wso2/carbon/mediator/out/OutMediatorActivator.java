 ...
 * 
 */
public class OutMediatorActivator implements BundleActivator {

    private static final Log log = LogFactory.getLog(OutMediatorActivator.class);
    ...
    public void stop(BundleContext bundleContext) throws Exception {
        if (log.isDebugEnabled()) {
            log.debug("Stopped the out mediator component ...");
        }
    }
}
