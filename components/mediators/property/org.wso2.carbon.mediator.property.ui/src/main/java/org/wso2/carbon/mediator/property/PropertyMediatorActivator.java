 ...
 *
 */
public class PropertyMediatorActivator implements BundleActivator {

    private static final Log log = LogFactory.getLog(PropertyMediatorActivator.class);
    ...
    public void start(BundleContext bundleContext) throws Exception {
        ...
        bundleContext.registerService(
                MediatorService.class.getName(), new PropertyMediatorService(), props);
