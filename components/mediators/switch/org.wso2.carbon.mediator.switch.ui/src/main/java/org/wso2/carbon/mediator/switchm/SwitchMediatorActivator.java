 ...
 *
 */
public class SwitchMediatorActivator implements BundleActivator {

    private static final Log log = LogFactory.getLog(SwitchMediatorActivator.class);
    ...
    public void stop(BundleContext bundleContext) throws Exception {
        if (log.isDebugEnabled()) {
            log.debug("Stopped the switch mediator component ...");
        }
    }
}
