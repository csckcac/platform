...
// Global variable which holds the org.wso2.carbon.policybuilder.ui.internal.context menu
var policyMenu = null;
...
function renderPolicyMenu() {
    ...
    policyMenu = new YAHOO.widget.ContextMenu("policy-menu", {
        ...
        container: "tab1",  // This org.wso2.carbon.policybuilder.ui.internal.property has to be set to a parent div, other than the treeview container div for IE to render properly
