...
<%
    ...
    try {
        ...
        client.updateClaimMappingBehavior(profile, configuration);
        String message = resourceBundle.getString("profile.configuration.updated.successfully");
        CarbonUIMessage.sendCarbonUIMessage(message,CarbonUIMessage.INFO, request);
        forwardTo = "index.jsp?region=region1&item=profile_mgt_menu&ordinal=0";
    } catch (Exception e) {
    	String message = resourceBundle.getString("error.while.updating.profile.configurations");
