...
<fmt:bundle basename="org.wso2.carbon.registry.reporting.ui.i18n.Resources">
    <div id="middle">
        <h2><fmt:message key="edit.report"/></h2>
        <div id="workArea">
            <div id="edit-report-div" style="padding-bottom:10px;">
                <form id="reportForm" name="reportForm" action="" method="POST">
                    <table class="styledLeft">
                        <thead>
                        <tr>
                            <th><fmt:message key="edit.report"/></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            <td class="formRow">
                                <table class="normal" cellspacing="0">
                                    <tr>
                                        <td class="leftCol-small" ><fmt:message key="report.name"/></td>
                                        <td>
                        ...
                        <tr>
                            <td class="buttonRow">
                                <input type="button" id="editReportButton" class="button registryWriteOperation" value="<fmt:message key="save"/>"
                                       onclick="addReport();"/>&nbsp;
                                <input type="button"
                                       class="button"
