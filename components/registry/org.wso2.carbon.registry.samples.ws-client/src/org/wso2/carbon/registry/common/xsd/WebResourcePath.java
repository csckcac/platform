       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       WebResourcePath.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":WebResourcePath",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "WebResourcePath",
                ...
                if (localNavigateNameTracker){
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"navigateName", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"navigateName");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("navigateName");
                                    }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"navigatePath", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"navigatePath");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("navigatePath");
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localNavigateNameTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://common.registry.carbon.wso2.org/xsd",
                                         ...
                                         elementList.add(localNavigateName==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localNavigateName));
                                    } if (localNavigatePathTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://common.registry.carbon.wso2.org/xsd",
                                                                      "navigatePath"));
                                 
                                         elementList.add(localNavigatePath==null?null:
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"WebResourcePath".equals(type)){
                                ...
                                return (WebResourcePath)org.wso2.carbon.registry.resource.services.utils.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://common.registry.carbon.wso2.org/xsd","navigateName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://common.registry.carbon.wso2.org/xsd","navigatePath").equals(reader.getName())){
