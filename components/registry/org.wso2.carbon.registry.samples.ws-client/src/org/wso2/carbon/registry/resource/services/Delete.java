                ...
                if (localPathToDeleteTracker){
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"pathToDelete", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"pathToDelete");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("pathToDelete");
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localPathToDeleteTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://services.resource.registry.carbon.wso2.org",
                                         ...
                                         elementList.add(localPathToDelete==null?null:
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"delete".equals(type)){
                                ...
                                return (Delete)org.wso2.carbon.registry.resource.services.utils.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.resource.registry.carbon.wso2.org","pathToDelete").equals(reader.getName())){
