...
@XmlType(propOrder = {"driverClassName", "url", "username", "password", "defaultAutoCommit",
        ...
        "abandonWhenPercentageFull", "maxAge", "useEquals", "suspectTimeout", "alternateUsernameAllowed",
        "dataSourceClassName", "dataSourceProps"})
public class RDBMSDSXMLConfiguration implements DSXMLConfiguration {
    ...
    public RDBMSDSXMLConfiguration() throws RSSManagerException {
        JAXBContext ctx;
        try {
