...
/**
 * Filtering outputs defined in the configuration based on results and any other facts
 * TODO In the 1.0 version of the rule component this is not used
 */
public interface OutputsFilter {

    /**
     * @param outputs            ResourceDescriptions to be filtered
     * @param results            Results from the rule engine
     ...
     */
    List<ResourceDescription> filter(List<ResourceDescription> outputs,
                                     List results,
                                     Object context,
