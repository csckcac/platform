...
/**
 * CEP extension for OperationDescription. This contains in/out event stream information
 */
public class CEPOperationExtensionDescription extends OperationExtensionDescription {
    ...
    public void setInputEventStream(EventStreamDescription inputEventStream) {
    ...
    public void setOutputEventStream(EventStreamDescription outputEventStream) {
