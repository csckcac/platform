...
function createFactEditorLLink(category, i) {
    ...
    factHref.appendChild(document.createTextNode(ruleservicejsi18n[category + ".type"]));
    factHref.onclick = function () {
...
function deleteFact(category, i) {
    CARBON.showConfirmationDialog(ruleservicejsi18n[category + ".delete.confirmation"], function() {
