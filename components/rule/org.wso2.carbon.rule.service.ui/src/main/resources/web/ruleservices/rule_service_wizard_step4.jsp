...
<%
    ...
    RuleServiceManagementHelper.saveStep5(serviceDescription, request);
    Iterator<OperationDescription> iterator =
            serviceDescription.getOperationDescriptions();
%>
                    ...
                    <tr>
                        <td class="formRaw">
                            <table class="styledLeft" id="operationtable">
                                <%
                                    if (serviceDescription.containsOperationDescriptions()) {
                                %>
                                <thead>
                                <tr>
                                ...
                                <% int j = 0;
                                    while (iterator.hasNext()) {
                                        ...
                                        if (operationDescription != null) {
                                            String name = operationDescription.getName().getLocalPart();
                                %>
