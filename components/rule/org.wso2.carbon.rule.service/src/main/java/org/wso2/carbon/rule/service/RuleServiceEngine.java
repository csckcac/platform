...
/**
 * ServiceEngine implementation for rules 
 */
public class RuleServiceEngine extends ServiceEngine {
    ...
    public RuleServiceEngine(AxisService axisService, RuleEngine ruleEngine, String rulesetURI) {
        super(axisService);
    ...
    @Override
    public void registerResultListener(OutputManager manager,
