...
public class LoginPageFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest,
        ...
        String url = "/carbon/redirector/login.jsp";
        if (queryString != null && !queryString.equals("") && !queryString.equals("?")) {
            url += "?" + queryString;
        }  */
        ...
        url = url.replaceAll("admin/login.jsp", "tenant-login/login_ajaxprocessor.jsp");
