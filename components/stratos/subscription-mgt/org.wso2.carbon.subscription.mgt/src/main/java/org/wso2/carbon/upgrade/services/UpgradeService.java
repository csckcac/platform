...
public class UpgradeService extends AbstractAdmin {
    ...
    public PackageInfoBean[] getPackageInfo() throws Exception {
        return Util.getPackageInfo((UserRegistry)getGovernanceRegistry());
    }

    public SubscriptionInfoBean getCurrentSubscription() throws Exception {
        return Util.getCurrentSubscriptionInfo((UserRegistry)getGovernanceRegistry());
    }

    public void updateSubscription(String packageName, String durationInMonth) throws Exception {
        Util.updateSubscriptionInfo(packageName, durationInMonth, (UserRegistry)getGovernanceRegistry());
    }

    public void cancelSubscription() throws Exception {
        Util.cancelSubscriptionInfo((UserRegistry)getGovernanceRegistry());
    }
}
