...
/**
 * @scr.component name="org.wso2.carbon.tenant.reg.agent.service.internal.TenantRegServiceComponent" immediate="true"
 * @scr.reference name="org.wso2.carbon.tenant.mgt.listener.service"
 * interface="org.wso2.carbon.stratos.common.listeners.TenantMgtListener" cardinality="0..n"
 * policy="dynamic" bind="setTenantMgtListenerService"
