...
/**
 * util class which is doing add host to engine and getting resources from the registry.
 */
public class HostUtil {
    ...
    /**
     * This method is used to retrieve list of host names for a given webapplication.
     *
     * @param webAppName
    ...
    /**
     * It is taken the webApp which is already deployed in /repository/../webapps
     * and redeploy it within added virtual host.
     *
     ...
     */
    public static void addWebAppToHost(String hostName,
    ...
    public static String getContextFromUri(String uri) {
        //context path is /t/tenantdomain/webapps/webapp-context, then the context is webapp-context
