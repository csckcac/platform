...
public class AMQConnectionDelegate_8_0 implements AMQConnectionDelegate
{
                                                     ...
                                                     final int prefetchHigh, final int prefetchLow) throws JMSException
    {
        ...
        return new FailoverRetrySupport<org.wso2.andes.jms.Session, JMSException>(
                new FailoverProtectedOperation<org.wso2.andes.jms.Session, JMSException>()
                {
                    public org.wso2.andes.jms.Session execute() throws JMSException, FailoverException
                    {
