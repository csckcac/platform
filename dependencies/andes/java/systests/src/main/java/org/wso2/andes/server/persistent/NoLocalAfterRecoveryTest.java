 ...
 *
 */
package org.wso2.andes.server.persistent;
...
import org.wso2.andes.server.store.DerbyMessageStore;
...
public class NoLocalAfterRecoveryTest extends QpidBrokerTestCase implements ConnectionListener
{
    ...
    protected void setUp() throws Exception
    {
        ...
        configuration.setProperty("virtualhosts.virtualhost.test.store.class", "org.wso2.andes.server.store.DerbyMessageStore");
