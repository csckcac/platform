...
public class QueryProcessor
{
    ...
    throws InvalidRequestException, UnavailableException, TimedOutException
    {
        ...
        for (UpdateStatement update : updateStatements)
        {
            ...
            {
                clientState.hasColumnFamilyAccess(update.getColumnFamily(), Permission.WRITE, Action.UPDATE);
    ...
    throws RecognitionException, UnavailableException, InvalidRequestException, TimedOutException, SchemaDisagreementException
    {
        ...
        switch (statement.type)
        {
            ...
            case TRUNCATE:
                ...
                clientState.hasColumnFamilyAccess(columnFamily, Permission.WRITE, Action.UPDATE);
            ...
            case CREATE_KEYSPACE:
                ...
                create.validate();
                clientState.hasKeyspaceSchemaAccess(Permission.WRITE,Action.UPDATE);
            ...
            case CREATE_COLUMNFAMILY:
                ...
                clientState.hasColumnFamilySchemaAccess(Permission.WRITE, Action.UPDATE);
                validateSchemaAgreement();
