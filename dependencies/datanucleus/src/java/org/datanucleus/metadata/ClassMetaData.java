                    ...
                    !Modifier.isStatic(clsFields[i].getModifiers()))
                {
                    ...
                    if (Collections.binarySearch(members, clsFields[i].getName()) < 0)
                    {
                        ...
                        else
                        {
                            ...
                            NucleusLogger.METADATA.debug(LOCALISER.msg("044060", clsFields[i].getName(), name));
                            AbstractMemberMetaData mmd = new FieldMetaData(this, clsFields[i].getName());
                            members.add(mmd);
                            Collections.sort(members);
                        }
            ...
            if (pkMembers == mmd.isPrimaryKey())
            {
                ...
                if (mmd instanceof PropertyMetaData)
                {
                    ...
                    if (setMethod == null && mmd.getPersistenceModifier() != FieldPersistenceModifier.NONE)
                    {
                        ...
                        throw new InvalidMetaDataException(LOCALISER, "044074", fullName, mmd.getName());
                    }
                ...
                if (!populated)
                {
                    ...
                    throw new InvalidMetaDataException(LOCALISER, "044071", fullName,mmd.getFullFieldName());
                }
            }
        }
    }
                ...
                if (mmd.isFieldToBePersisted())
                {
                    ...
                    else
                    {
                        ...
                        if (pcSuperclassMetaData == null)
                        {
                            ...
                            throw new InvalidMetaDataException(LOCALISER, "044162", mmd.getFullFieldName());
                        }
