...
public class MapMetaData extends ContainerMetaData
{
    ...
    public MapMetaData setEmbeddedKey(String embedded)
    {
    ...
    public MapMetaData setSerializedKey(String serialized)
    {
    ...
    public MapMetaData setDependentKey(String dependent)
    {
    ...
    public MapMetaData setEmbeddedValue(String embedded)
    {
    ...
    public MapMetaData setSerializedValue(String serialized)
    {
    ...
    public MapMetaData setDependentValue(String dependent)
    {
