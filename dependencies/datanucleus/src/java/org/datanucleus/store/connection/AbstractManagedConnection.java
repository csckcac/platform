...
public abstract class AbstractManagedConnection implements ManagedConnection
{
     ...
     * Means that it should not "commit" the connection (the commit is done elsewhere), 
     * nor should it close the connection when release() is called (the connection is retained for further use).
     */
    ...
    /**
     * Method to set that this connection is "pooled". That is, when it is released it is not closed, and instead
     * is pooled for the next request.
     */
