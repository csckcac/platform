...
public abstract class MappedStoreManager extends AbstractStoreManager implements BackedSCOStoreManager
{
    ...
    protected void initialiseIdentifierFactory(NucleusContext nucleusContext)
    {
        ...
        try
        {
            ...
            String val = getStringProperty("datanucleus.identifier.case");
            if (val != null)
            {
            ...
            val = getStringProperty("datanucleus.identifier.wordSeparator");
            if (val != null)
            {
                props.put("WordSeparator", val);
            }
            val = getStringProperty("datanucleus.identifier.tablePrefix");
            if (val != null)
            {
                props.put("TablePrefix", val);
            }
            val = getStringProperty("datanucleus.identifier.tableSuffix");
            if (val != null)
            {
