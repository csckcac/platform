 ...
 */
class AppIDObjectIdFieldConsumer implements ObjectIdFieldConsumer
{
     ...
     */
    public AppIDObjectIdFieldConsumer(int[] param, ExecutionContext ec, Object statement, JavaTypeMapping[] javaTypeMappings)
    {
        this.params = param;
        nextParam = 0;
        this.ec = ec;
