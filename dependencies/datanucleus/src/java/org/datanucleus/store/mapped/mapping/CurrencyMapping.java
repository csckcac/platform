...
import org.datanucleus.store.types.CurrencyStringConverter;
...
{
    private static CurrencyStringConverter converter = new CurrencyStringConverter();
    ...
    {
        return converter.toObject(datastoreValue);
    }
}