 ...
 * datastore fields.
 */
public class Rectangle2dFloatMapping extends SingleFieldMultiMapping
{
    /* (non-Javadoc)
    ...
    public void setObject(ExecutionContext ec, Object preparedStatement, int[] exprIndex, Object value)
    {
        ...
        {
            getDatastoreMapping(0).setFloat(preparedStatement,exprIndex[0],rectangle.x);
            getDatastoreMapping(1).setFloat(preparedStatement,exprIndex[1],rectangle.y);
            getDatastoreMapping(2).setFloat(preparedStatement,exprIndex[2],rectangle.width);
            getDatastoreMapping(3).setFloat(preparedStatement,exprIndex[3],rectangle.height);
        }
    }
