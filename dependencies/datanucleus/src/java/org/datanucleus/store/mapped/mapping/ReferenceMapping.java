...
public abstract class ReferenceMapping extends MultiMapping implements MappingCallbacks
{
            ...
            boolean embedded, int fieldRole, ColumnMetaData[] columnMetaData, ClassLoaderResolver clr)
    {
        ...
        catch (NucleusUserException nue)
        {
            ...
            if (storeMgr.getBooleanProperty("datanucleus.store.allowReferencesWithNoImplementations", false))
            {
        ...
        while (implClsIter.hasNext())
        {
            ...
            if (columnsNeeded)
            {
                ...
                // TODO Remove the call to an RDBMS class
    ...
    protected String getReferenceStringForObject(ExecutionContext ec, Object value)
    {
        ...
        else
        {
            ...
            throw new NucleusException("Identity mapping of interface/Object fields not yet supported");
        }
    }
