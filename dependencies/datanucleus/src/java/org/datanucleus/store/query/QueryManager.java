...
public class QueryManager
{
    ...
    public Query newQuery(String language, ExecutionContext ec, Object query)
    {
        ...
        try
        {
            if (query == null)
            {
                Class[] argsClass = new Class[] {StoreManager.class, ExecutionContext.class};
            ...
            else
            {
                ...
                if (query instanceof String)
                {
                    ...
                    Class[] argsClass = new Class[]{StoreManager.class, ExecutionContext.class, String.class};
                ...
                else if (query instanceof Query)
                {
                    ...
                    Class[] argsClass = new Class[]{StoreManager.class, ExecutionContext.class, query.getClass()};
                    Object[] args = new Object[]{storeMgr, ec, query};
                    q = (Query) ec.getNucleusContext().getPluginManager().createExecutableExtension(
                        "org.datanucleus.store_query_query", new String[] {"name", "datastore"},
                        new String[] {languageImpl, ec.getStoreManager().getStoreManagerKey()}, 
                ...
                else
                {
                    ...
                    Class[] argsClass = new Class[]{StoreManager.class, ExecutionContext.class, Object.class};
                    Object[] args = new Object[]{storeMgr, ec, query};
                    q = (Query) ec.getNucleusContext().getPluginManager().createExecutableExtension(
                        "org.datanucleus.store_query_query", new String[] {"name", "datastore"},
                        new String[] {languageImpl, ec.getStoreManager().getStoreManagerKey()}, 
