 ...
 */
public class ArrayList extends org.datanucleus.store.types.sco.simple.ArrayList
{
     ...
     */
    public ArrayList(ObjectProvider ownerSM, String fieldName)
    {
                ...
                fmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT)
        {
            ...
            ((BackedSCOStoreManager)ec.getStoreManager()).getBackingStoreForField(clr, fmd, java.util.ArrayList.class);
        }
