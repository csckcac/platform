 ...
 */
public class HashMap extends org.datanucleus.store.types.sco.simple.HashMap
{
     ...
     */
    public HashMap(ObjectProvider ownerSM, String fieldName)
    {
                ...
                fmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT)
        {
            ...
            ((BackedSCOStoreManager)ec.getStoreManager()).getBackingStoreForField(clr, fmd, java.util.HashMap.class);
        }
