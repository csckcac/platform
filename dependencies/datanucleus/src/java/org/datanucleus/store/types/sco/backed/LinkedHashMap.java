 ...
 */
public class LinkedHashMap extends org.datanucleus.store.types.sco.simple.LinkedHashMap
{
     ...
     */
    public LinkedHashMap(ObjectProvider ownerSM, String fieldName)
    {
                ...
                fmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT)
        {
            ...
            ((BackedSCOStoreManager)ec.getStoreManager()).getBackingStoreForField(clr, fmd, java.util.LinkedHashMap.class);
        }
