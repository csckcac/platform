 ...
 */
public class LinkedHashSet extends org.datanucleus.store.types.sco.simple.LinkedHashSet
{
     ...
     */
    public LinkedHashSet(ObjectProvider ownerSM, String fieldName)
    {
                ...
                fmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT)
        {
            ...
            ((BackedSCOStoreManager)ec.getStoreManager()).getBackingStoreForField(clr, fmd, java.util.LinkedHashSet.class);
        }
