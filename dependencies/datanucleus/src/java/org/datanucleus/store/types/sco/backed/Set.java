 ...
 */
public class Set extends org.datanucleus.store.types.sco.simple.Set
{
     ...
     */
    public Set(ObjectProvider ownerSM, String fieldName)
    {
     ...
     */
    Set(ObjectProvider ownerSM, String fieldName, boolean allowNulls, SetStore backingStore)
    {
                ...
                fmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT)
        {
            ...
            ((BackedSCOStoreManager)ec.getStoreManager()).getBackingStoreForField(clr,fmd,java.util.Set.class);
        }
