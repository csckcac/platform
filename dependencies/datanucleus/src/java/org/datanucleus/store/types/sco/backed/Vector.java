 ...
 */
public class Vector extends org.datanucleus.store.types.sco.simple.Vector
{
    ...
    public Vector(ObjectProvider ownerSM, String fieldName)
    {
                ...
                fmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT)
        {
            ...
            ((BackedSCOStoreManager)ec.getStoreManager()).getBackingStoreForField(clr,fmd,java.util.Vector.class);
        }
