...
public class LinkedList extends java.util.LinkedList implements SCOList, Cloneable
{
     ...
     */
    public LinkedList(ObjectProvider ownerSM, String fieldName)
    {
    ...
    public void initialise(Object o, boolean forInsert, boolean forUpdate)
    {
        ...
        if (c != null)
        {
            delegate = new java.util.LinkedList(c); // Make copy of container rather than using same memory
        }
        else
        {
    ...
    {
        java.util.Collection detached = new java.util.LinkedList();
    ...
    public Object remove(int index)
    {
        ...
        if (ownerSM != null && SCOUtils.hasDependentElement(ownerSM.getClassMetaData().getMetaDataForMember(fieldName)))
        {
            // Cascade delete
    ...
    public synchronized boolean remove(Object element, boolean allowCascadeDelete)
    {
        ...
        if (ownerSM != null && allowCascadeDelete && 
            SCOUtils.hasDependentElement(ownerSM.getClassMetaData().getMetaDataForMember(fieldName)))
        {
            // Cascade delete
            ownerSM.getExecutionContext().deleteObjectInternal(element);
        }
    ...
    public boolean removeAll(Collection elements)
    {
        ...
        {
            // Cascade delete
            if (SCOUtils.hasDependentElement(ownerSM.getClassMetaData().getMetaDataForMember(fieldName)))
            {
