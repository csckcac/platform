...
public class CassandraLazyValidator  extends
        CassandraLazyPrimitive<org.apache.hadoop.hive.serde2.lazy.objectinspector.CassandraValidatorObjectInspector, Text> {
  private final AbstractType validator;

  public CassandraLazyValidator(org.apache.hadoop.hive.serde2.lazy.objectinspector.CassandraValidatorObjectInspector oi) {
    super(oi);
