...
public class HiveConf extends Configuration {
  ...
  static {
    ...
    if (hiveSiteURL == null) {
      ...
      if (hiveSiteURL == null && System.getenv("PWD") != null) {
          String carbonHome = System.getenv("PWD");
          try {
              hiveSiteURL = new URL("file://" + carbonHome  + File.separator + "repository" + File.separator + "conf" + File.separator +
                                "hive-site.xml");
              System.out.println("Path : " + carbonHome + File.separator + "repository" + File.separator + "conf" + File.separator +
                                "hive-site.xml");
          } catch (MalformedURLException e) {
              l4j.error("Incorrect URL ");
              e.printStackTrace();
