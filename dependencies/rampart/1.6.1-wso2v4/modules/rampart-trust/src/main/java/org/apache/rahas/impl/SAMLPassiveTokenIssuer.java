...
public class SAMLPassiveTokenIssuer extends SAMLTokenIssuer {
    ...
    public void setAudienceRestrictionCondition(String uri) throws TrustException {
        ...
        OMElement audienceRestriction = null;
        OMElement audience = null;

        factory = OMAbstractFactory.getOMFactory();
        audienceRestriction = factory
                .createOMElement(AudienceRestrictionCondition.DEFAULT_ELEMENT_NAME);
        audience = factory.createOMElement(Audience.DEFAULT_ELEMENT_NAME);
        audience.setText(uri);
        audienceRestriction.addChild(audience);
        try {
            this.audienceRestriction = XMLUtils.toDOM(audienceRestriction);
        } catch (Exception e) {
