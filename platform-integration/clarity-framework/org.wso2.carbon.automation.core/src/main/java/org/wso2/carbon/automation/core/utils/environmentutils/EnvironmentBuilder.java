...
public class EnvironmentBuilder {
    ...
    public EnvironmentBuilder as(int userId)
        ...
        adminServiceAuthentication = new AuthenticatorClient(backEndUrl);
    ...
    public EnvironmentBuilder axis2(int userId)
        ...
        AuthenticatorClient adminServiceAuthentication;
        backEndUrl = axis2Setter.getBackendUrl();
        serverHostName = axis2Setter.getHostName();
        httpPort = axis2Setter.getHttpPort();
        productVariables = loginSetupAxis2(userId, frameworkProperties, axis2Setter);
        this.axis2 = productVariables;
        return this;
    }
    ...
    private EnvironmentVariables loginSetup(int userID, String httpPort,
                                            AuthenticatorClient adminServiceAuthentication,
                                            FrameworkProperties frameworkProperties,
    ...
    private EnvironmentVariables loginSetupAxis2(int userID,
        ...
        UserInfo userInfo = UserListCsvReader.getUserInfo(userID);
        serviceUrl = getServiceURL(frameworkProperties, productSetter, userInfo);
        productVariables.setEnvironment(backEndUrl, serviceUrl, userInfo, productSetter);
        return productVariables;
    }
