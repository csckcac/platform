...
import org.wso2.carbon.admin.service.AdminServiceSpringServiceFileUploader;
...
public class SpringServiceMaker {
    ...
    public SpringBeansData getSpringBeanNames(String springContextFilePath, String springBeanFilePath, ClassLoader bundleClassLoader) throws AxisFault {
    ...
    public void createAndUploadSpringBean(String springContextFilePath, String springBeanFilePath, String sessionCookie,String backendURL) throws Exception {
        ...
        try {
            AdminServiceSpringServiceFileUploader uploderClient =
                    new AdminServiceSpringServiceFileUploader(backendURL);
            uploderClient.uploadSpringServiceFile(sessionCookie, archiveFileName + ".aar", dataHandler);
        } catch (Exception e) {
