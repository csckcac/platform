...
public class AdminServiceMassageStoreAdmin {
    ...
    public AdminServiceMassageStoreAdmin(String backendUrl, String sessionCookie) {
    ...
    public void addMesageStore(DataHandler dh)
        ...
        messageStoreAdminServiceStub = this.setMessageStroeStubStub();
