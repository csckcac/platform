...
public class SoapUICore extends AbstractMojo {
    ...
    SoapUIProperties properties;
    private String resourcePath = ProductConstant.SYSTEM_TEST_RESOURCE_LOCATION+File.separator
                                  +"soapuiresources"+ File.separator;

    public void runner(SoapUIProperties newproperties)
