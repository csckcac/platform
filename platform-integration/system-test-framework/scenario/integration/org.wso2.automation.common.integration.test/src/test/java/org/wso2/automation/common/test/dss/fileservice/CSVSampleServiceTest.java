...
public class CSVSampleServiceTest extends DataServiceTest {
    private static final Log log = LogFactory.getLog(CSVSampleServiceTest.class);

    @Override
    protected void setServiceName() {
        serviceName = "CSVSampleService";
    }
