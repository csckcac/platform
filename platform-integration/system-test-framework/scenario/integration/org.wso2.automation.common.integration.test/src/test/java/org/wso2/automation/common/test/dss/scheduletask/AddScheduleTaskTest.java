...
public class AddScheduleTaskTest extends DataServiceTest {
    private static final Log log = LogFactory.getLog(AddScheduleTaskTest.class);
    ...
    @Test(priority = 5, dependsOnMethods = {"verifyTaskCount"})
