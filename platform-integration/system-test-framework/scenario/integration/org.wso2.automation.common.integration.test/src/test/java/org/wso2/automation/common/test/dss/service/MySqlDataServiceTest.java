...
public class MySqlDataServiceTest extends DataServiceTest {
    private static final Log log = LogFactory.getLog(MySqlDataServiceTest.class);
    ...
    @Test(priority = 3, dependsOnMethods = {"insertOperation"})
    ...
    @Test(priority = 5, dependsOnMethods = {"updateOperation"})
