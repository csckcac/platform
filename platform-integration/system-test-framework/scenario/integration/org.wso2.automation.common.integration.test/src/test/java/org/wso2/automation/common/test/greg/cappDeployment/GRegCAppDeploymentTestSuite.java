...
public class GRegCAppDeploymentTestSuite extends MasterTestSuite {
    @AfterSuite
    public void suiteRunner() {
        List<SuiteVariables> suiteVariablesList = new ArrayList<SuiteVariables>();
        suiteVariablesList.add(new SuiteVariables("UploadCarFileHavingTextResourcesTest",
                                                  UploadCarFileHavingTextResourcesTest.class));


        setServerList(ProductConstant.GREG_SERVER_NAME);
        superSuite("GRegCAppDeploymentTestSuite", suiteVariablesList).run();

    }

    public static void main(String[] args) {
        new GRegCAppDeploymentTestSuite().suiteRunner();
