...
public class WSDLImportServiceTestClient {
    ...
    private void testAddSimpleWsdl_Import() throws org.wso2.carbon.registry.api.RegistryException {
    ...
    private void testAddUppercase_WSDL_extension() throws org.wso2.carbon.registry.api.RegistryException {
    ...
    public void propertyAssertion(String wsdl_path, String property1, String property2, String property3) throws RegistryException {
        Resource resource;
        try {
    ...
    public void wsdlContentAssertion(String wsdl_path, String keyword1, String keyword2) throws org.wso2.carbon.registry.api.RegistryException {
        String content = null;
        try {
