...
public class ISTestSuite extends MasterTestSuite {
    ...
    public void suiteRunner() {
        ...
        suiteVariablesList.add(new SuiteVariables("AuthorizationCachingTest",
                                                  AuthorizationCachingTest.class));
        setServerList(ProductConstant.IS_SERVER_NAME);
        superSuite("IdentityTestSuite", suiteVariablesList).run();
    }


    public static void main(String[] args) {
        new ISTestSuite().suiteRunner();
    }
}
