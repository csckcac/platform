...
public class asSecurityUtils implements CallbackHandler {
    ...
    public static OMElement runSecurityClient(int scenarioNo, String endpoint,
        ...
        String key_path = properties.getEnvironmentVariables().getKeystorePath();
        String security_policy_path = ProductConstant.getSecurityScenarios() + File.separator +  security_scenario_no + "-policy.xml";
        String axis2ModulePath = ProductConstant.getModuleClientPath();
        System.setProperty("javax.net.ssl.trustStore", key_path);
        System.setProperty("javax.net.ssl.trustStorePassword", "wso2carbon");
        ConfigurationContext ctx = ConfigurationContextFactory.createConfigurationContextFromFileSystem(axis2ModulePath, null);
