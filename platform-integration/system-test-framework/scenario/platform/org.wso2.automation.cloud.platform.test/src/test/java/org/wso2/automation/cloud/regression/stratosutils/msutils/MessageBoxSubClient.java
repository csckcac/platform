...
public class MessageBoxSubClient {
    ...
    private String backEndServicesString;
    private UserInfo userInfo;
    private String userName;
    private String password;

    public MessageBoxSubClient(String backEndUrl, UserInfo userInfo) {
        this.backEndServicesString = backEndUrl;
    ...
    public String createMessageBox() throws JMSException {
        try {
            ...
            QueueServiceStub stub = new QueueServiceStub(backEndServicesString + "t/" + userInfo.getDomain() + "/" + userID + "/QueueService");
