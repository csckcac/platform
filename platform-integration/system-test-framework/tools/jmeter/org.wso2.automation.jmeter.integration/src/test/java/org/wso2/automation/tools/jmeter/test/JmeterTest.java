...
public class JmeterTest {
    ...
    @Test
    public void testJmeterScripts() throws MojoExecutionException, MojoFailureException {
        boolean status = true;

        List<String> errorList = new LinkedList<String>();
        JmeterProperties jmeterProperties = new JmeterProperties();
        jmeterProperties.setProperty("/home/dharshana/jmeterSample",
                                     "/home/dharshana/jmeterSample",
                                     "/home/dharshana/stratos/target/jmeter",
                                     "/home/dharshana/jmeterSample/jmeter.log");
