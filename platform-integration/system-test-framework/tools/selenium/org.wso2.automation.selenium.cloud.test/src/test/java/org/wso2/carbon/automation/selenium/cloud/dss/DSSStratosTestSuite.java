...
public class DSSStratosTestSuite extends MasterTestSuite {
    ...
    public void suiteRunner() {
        ...
        if (env.getFrameworkSettings().getEnvironmentSettings().is_runningOnStratos()) {
            suiteVariablesList.add(new SuiteVariables("DSSPrivilegeGroupSeleniumTest",
                                                      DSSPrivilegeGroupSeleniumTest.class));
            suiteVariablesList.add(new SuiteVariables("DSSCreateDatabaseSeleniumTest",
                                                      DSSCreateDatabaseSeleniumTest.class));
