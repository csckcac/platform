...
The API provider module allows API publishers to easily define APIs and manage them
...
1. Extract the wso2am-1.0.0-SNAPSHOT.zip and go to the 'bin' directory
...
All known issues of WSO2 API Manager are filed at:
    ...
    https://wso2.org/jira/secure/IssueNavigator.jspa?requestId=10682
