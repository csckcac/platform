...
3.Change port offset to 1 by editing the repository/conf/carbon.xml
4.Start WSO2 BAM server
5.Go to StatClient directory and run "ant initialize_column_family_datastore" command (This will take around 10 minutes to complete. You need to have an Internet connection.)
