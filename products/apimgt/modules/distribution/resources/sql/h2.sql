...
CREATE INDEX IDX_ACCESS_TOKEN ON AM_KEY_CONTEXT_MAPPING(ACCESS_TOKEN, CONTEXT, VERSION);
CREATE INDEX IDX_SUB_APP_ID ON AM_SUBSCRIPTION (APPLICATION_ID, SUBSCRIPTION_ID);
CREATE INDEX IDX_KEY_CONTEXT_MAPPING ON AM_SUBSCRIPTION_KEY_MAPPING (KEY_CONTEXT_MAPPING_ID);
