...
curl -X POST -b cookies $SERVER/apiprovider/site/blocks/life-cycles/ajax/life-cycles.jag -d "name=PlaceFinder&version=1.0.0&provider=admin&status=PUBLISHED&publishToGateway=true&action=updateStatus";
