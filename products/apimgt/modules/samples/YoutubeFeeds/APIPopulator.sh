...
curl -X POST -b cookies $SERVER/apiprovider/site/blocks/life-cycles/ajax/update-status.jag -d "name=YoutubeFeeds&version=1.0.0&provider=admin&status=PUBLISHED&publishToGateway=true&action=updateStatus";
