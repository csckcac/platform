...
CREATE TABLE EVENT (id BIGINT NOT NULL, DETAILS VARCHAR(255), NEW_STATE VARCHAR(255), OLD_STATE VARCHAR(255), TIMESTAMP DATETIME NOT NULL, TYPE VARCHAR(255) NOT NULL, USER VARCHAR(255) NOT NULL, TASK_ID BIGINT, PRIMARY KEY (id));
