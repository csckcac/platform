...
rem ---------------------------------------------------------------------------
rem Client script for the handlers_jaxws Sample 
rem
...
cd %WSO2AppServer_HOME%\samples\Jaxws-Jaxrs\handlers_jaxws
...
%_RUNJAVA% %JAVA_OPTS% -Dwso2appserver.home="%WSO2AppServer_HOME%" -cp "%CLIENT_CLASSPATH%" -Djava.endorsed.dirs="%WSO2AppServer_HOME%\lib\endorsed";"%JAVA_HOME%\jre\lib\endorsed";"%JAVA_HOME%\lib\endorsed" demo.handlers.client.Client src/main/resources/addNumbers.wsdl %*
cd %CURRENT_DIR%
endlocal
:end
