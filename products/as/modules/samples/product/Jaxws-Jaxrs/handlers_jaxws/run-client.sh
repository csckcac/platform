...
for f in "$CARBON_HOME"/samples/Jaxws-Jaxrs/handlers_jaxws/build/lib/*.jar
do
...
CLIENT_CLASSPATH="$CARBON_HOME/samples/Jaxws-Jaxrs/handlers_jaxws/build/classes":$CLIENT_CLASSPATH
...
demo.handlers.client.Client src/main/resources/addNumbers.wsdl$*
