...
for f in "$CARBON_HOME"/samples/Jaxws-Jaxrs/ws_security/sign_encrypt/temp/dependencies/*.jar
do
...
CLIENT_CLASSPATH="$CARBON_HOME/samples/Jaxws-Jaxrs/ws_security/sign_encrypt/temp/classes":$CLIENT_CLASSPATH
...
demo.wssec.client.Client src/main/resources/hello_world_wssec.wsdl$*
#!/bin/sh
# -----------------------------------------------------------------------------
#
# Environment Variable Prequisites
