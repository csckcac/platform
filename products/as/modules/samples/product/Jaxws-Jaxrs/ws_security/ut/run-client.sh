...
for f in "$CARBON_HOME"/samples/Jaxws-Jaxrs/ws_security/ut/temp/dependencies/*.jar
do
...
demo.wssec.client.Client src/main/resources/hello_world_wssec_client.wsdl$*
