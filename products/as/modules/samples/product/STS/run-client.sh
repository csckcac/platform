...
CLIENT_CLASSPATH="$WSO2AppServer_HOME/samples/STS/temp/classes":\
"$WSO2AppServer_HOME/samples/STS/conf":$CLIENT_CLASSPATH
...
org.wso2.appserver.sample.sts.client.Client $*
