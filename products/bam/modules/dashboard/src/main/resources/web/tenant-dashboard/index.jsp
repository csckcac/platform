            ...
            <tr>
                <td class="tip-content">
                    <div class="tip-content-lifter">
                        ...
                        if (hasPermission) {
                        %>
                        <a class="tip-title" href="../bam-server-data/mediation_data.jsp?region=region1&item=bam_menu_mediation">Real Time Mediation Monitoring </a> <br/>
                        <%
                            } else {
                        %>
                        <h3 class="tip-title">Real Time Mediation Monitoring<br/></h3>
                        <%
                            }
                        %>
                ...
                <td class="tip-content">
                    <div class="tip-content-lifter">
                        <%
                            if (hasPermission) {
                        %>
                        <a class="tip-title" href="../bam-server-data/mediation_analytics.jsp?region=region1&item=bam_menu_mediation_analytics">Mediation Analysis</a><br/>
                        <%
                        } else {
                        %>
                        <h3 class="tip-title">Mediation Analysis</br/></h3>
                        <%
                            }
                        %>
                ...
                <td class="tip-content">
                    <div class="tip-content-lifter">
                        ...
                        if (hasPermission) {
                        %>
                        <a class="tip-title" href="../bam-server-data/service_data.jsp?region=region1&item=bam_menu_service">Real time Service Monitoring </a> <br/>
                        <%
                            } else {
                        %>
                        <h3 class="tip-title">Real time Service Monitoring<br/></h3>
                        <%
                            }
                        %>
            ...
            <tr>
                <td class="tip-content">
                    <div class="tip-content-lifter">
                        ...
                        if (hasPermission) {
                        %>
                        <a class="tip-title" href="../bam-server-data/service_stats.jsp?region=region1&item=bam_menu_service_stats">Service Invocation Analysis</a> <br/>
                        <%
                            } else {
                        %>
                        <h3 class="tip-title">Service Invocation Analysis<br/></h3>
                        <%
                            }
                        %>
                ...
                <td class="tip-content">
                    <div class="tip-content-lifter">
                        <%
                            if (hasPermission) {
                        %>
                        <a class="tip-title" href="../dashboard/index.jsp?region=region1&item=bam_menu_dashboard&name=bam">Dashboard</a><br/>
                        <%
                        } else {
                        %>
                        <h3 class="tip-title">Dashboard<br/></h3>
                        <%
                            }
                        %>
