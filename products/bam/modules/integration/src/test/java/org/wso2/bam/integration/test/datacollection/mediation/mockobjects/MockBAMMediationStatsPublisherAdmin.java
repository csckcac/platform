...
public class MockBAMMediationStatsPublisherAdmin extends BAMMediationStatsPublisherAdmin {

    private MediationStatConfig config;

    public void configureEventing(MediationStatConfig mediationStatConfig) {
        this.config = mediationStatConfig;
    }
