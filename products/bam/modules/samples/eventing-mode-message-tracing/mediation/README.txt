 This file explains how to trace mediation activities in eventing mode using WSO2 Business Activity Monitor.
=============================================================================================================
...
1. Go to management console of the ESB management console, and select Configure > Features from the side panel.
...
3. Search and install "BAM Activity Mediation Data Publisher" feature

4. Restart the ESB server

5. Go to management console of the application server, and select "Configure > Activity Mediation" from the side panel.
