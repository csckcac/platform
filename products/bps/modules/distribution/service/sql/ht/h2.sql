CREATE TABLE DEADLINE (id BIGINT NOT NULL, COMPLETION BIT, DEADLINE_DATE TIMESTAMP, ESCALATION_NAME VARCHAR(255), TASK_ID BIGINT, PRIMARY KEY (id));
...
CREATE TABLE MESSAGE_PART (MESSAGE_PART_ID BIGINT NOT NULL, MESSAGE_PART_CONTENT CLOB, MESSAGE_PART_NAME VARCHAR(255), MESSAGE_PART_TYPE VARCHAR(255), MESSAGE_MESSAGE_ID BIGINT, KEY0 VARCHAR(255), PRIMARY KEY (MESSAGE_PART_ID));
...
CREATE TABLE TASK (id BIGINT NOT NULL, ACTIVATION_TIME TIMESTAMP, CREATED_ON TIMESTAMP, ESCALATED BIT, EXPIRATION_TIME TIMESTAMP, NAME VARCHAR(255) NOT NULL, PRIORITY INTEGER, SKIPABLE BIT, STATUS VARCHAR(255) NOT NULL, STATUS_BEFORE_SUSPENSION VARCHAR(255), TYPE VARCHAR(255) NOT NULL, PRIMARY KEY (id));
CREATE TABLE TASK_ATTACHMENT (id BIGINT NOT NULL, ACCESS_TYPE VARCHAR(255), ATTACHED_AT TIMESTAMP, CONTENT_TYPE VARCHAR(255), ATTACHMENT_NAME VARCHAR(255), VALUE VARCHAR(255), ATTACHED_BY BIGINT, TASK_ID BIGINT, PRIMARY KEY (id));
CREATE TABLE TASK_COMMENT (id BIGINT NOT NULL, COMMENT_TEXT VARCHAR(8192), COMMENTED_ON TIMESTAMP, TASK_ID BIGINT, COMMENTEDBY_ORG_ENTITY_ID BIGINT, PRIMARY KEY (id));
