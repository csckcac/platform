...
$JAVACMD $PROGRAM_PARAMS -Djava.io.tmpdir=$AXIS2_HOME/../../tmp/sampleServer -Djava.endorsed.dirs=$AXIS2_ENDORSED -classpath $AXIS2_CLASSPATH org.wso2.bps.samples.util.SampleAxis2Server \
