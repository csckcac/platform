...
createTaskOutput = function() {
    ...
    if(outputVal == 'approve') {
		return '<sch:HTWSDAUEResponse xmlns:sch="http://www.example.com/claims/schema"><sch:approved>true</sch:approved></sch:HTWSDAUEResponse>';
	} else if (outputVal == 'disapprove') {
		return '<sch:HTWSDAUEResponse xmlns:sch="http://www.example.com/claims/schema"><sch:approved>false</sch:approved></sch:HTWSDAUEResponse>';
	}
};
