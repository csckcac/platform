...
public class CarRentalServiceTestCase {

    @Test(groups = {"wso2.brs"})
    public void testCarRental() throws AxisFault, XMLStreamException {
        ClientConnectionUtil.waitForPort(9763);
        ServiceClient serviceClient = new ServiceClient();
        Options options = new Options();
        options.setTo(new EndpointReference("http://localhost:9763/services/CarRentalService"));
