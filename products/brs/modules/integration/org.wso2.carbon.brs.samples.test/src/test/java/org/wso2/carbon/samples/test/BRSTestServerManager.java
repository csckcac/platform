...
public class BRSTestServerManager extends TestServerManager {
    ...
    protected void copyArtifacts(String carbonHome) throws IOException {
        ...
        copySampleFile(computeSourcePath("BankingService.aar"), deploymentDir);

        /*GetQuote Service Sample*/
        copySampleFile(computeSourcePath("GetQuoteService.aar"), deploymentDir);

        /*Call Charging service sample*/
        copySampleFile(computeSourcePath("CallChargingService.aar"), deploymentDir);

        /*Car Rental Service Sample*/
        copySampleFile(computeSourcePath("CarRentalService.aar"), deploymentDir);

        /*Health care service sample*/
        copySampleFile(computeSourcePath("HealthCareService.aar"), deploymentDir);

        /*Insurance Service Sample*/
        copySampleFile(computeSourcePath("InsuranceService.aar"), deploymentDir);

        /*MIP Calculating service Sample*/
        copySampleFile(computeSourcePath("MIPCalculateService.aar"), deploymentDir);

        /*Order approval service sample*/
        copySampleFile(computeSourcePath("OrderApprovalService.aar"), deploymentDir);

        /*Shopping service sample*/
        copySampleFile(computeSourcePath("ShoppingService.aar"), deploymentDir);
    }
