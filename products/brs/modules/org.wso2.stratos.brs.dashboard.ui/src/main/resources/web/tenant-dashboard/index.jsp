        ...
        <tr>
            <td class="tip-content">
                <div class="tip-content-lifter">
                    ...
                    %>
                    <h3 class="tip-title">Message Tracing</h3><br/>
                    <%
                        }
                    %>

                    <p>Trace the request and responses to your service. Message Tracing is a vital debugging tool when
            ...
            <td class="tip-content">
                <div class="tip-content-lifter">
                    ...
                    %>
                    <h3 class="tip-title">WSDL2Java Tool</h3><br/>
                    <%
                        }
                    %>

                    <p>Use WSDL2Java tool in Business Process Server to convert Web Service WSDL to a set of Java
                        objects.</p>
            ...
            <td class="tip-content">
                <div class="tip-content-lifter">
                    ...
                    %>
                    <h3 class="tip-title">Java2WSDL Tool</h3><br/>
                    <%
                        }
                    %>

                    <p>Use Java2WSDL tool in Business Process Server to make it easy to develop a new web service.</p>
            ...
            <td class="tip-content">
                <div class="tip-content-lifter">
                    ...
                    %>
                    <h3 class="tip-title">WSDL Validator</h3><br/>
                    <%
                        }
                    %>

                    <p>Use WSDL Validator tool in Business Process Server to Validate WSDL by directly uploading them or
                        providing a URL.</p>
