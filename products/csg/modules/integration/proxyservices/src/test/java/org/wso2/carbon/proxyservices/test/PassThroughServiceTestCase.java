...
import org.wso2.csg.integration.ESBIntegrationTestCase;
import org.wso2.csg.integration.axis2.SampleAxis2Server;
import org.wso2.csg.integration.axis2.StockQuoteClient;
...
public class PassThroughServiceTestCase extends ESBIntegrationTestCase {
    ...
    @Test(groups = {"wso2.csg"}, description = "Test Pass through service.")
