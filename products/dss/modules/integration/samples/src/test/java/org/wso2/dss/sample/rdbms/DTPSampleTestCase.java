...
import org.wso2.carbon.dataservices.samples.dtp_sample.DataServiceFaultException;
...
public class DTPSampleTestCase {
    ...
    public void testXACreateSingleAccount() throws RemoteException, DataServiceFaultException {
    ...
    private int getAutoGeneratedIdFromElement(OMElement el) {
        String idStr = ((OMElement) ((OMElement) el.getChildrenWithLocalName("Entry").next())
                .getChildrenWithLocalName("ID").next()).getText();
        return Integer.parseInt(idStr);
    }

    @Test(groups = {"wso2.dss"})
    public void testXACreateSingleAccountNoStreamingResult() throws DataServiceFaultException, RemoteException {
    ...
    @Test(groups = {"wso2.dss"})
    public void testDistributedTransactionSuccess() throws RemoteException, DataServiceFaultException {
    ...
    public void testDistributedTransactionFail() throws DataServiceFaultException, RemoteException {
    ...
    @Test(groups = {"wso2.dss"})
    public void testDefaultValues() throws DataServiceFaultException, RemoteException {
