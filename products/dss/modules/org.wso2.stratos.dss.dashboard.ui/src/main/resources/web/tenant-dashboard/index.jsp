...
.tip-table td.contract-first-service {
	background-image:
		url(../../carbon/tenant-dashboard/images/contract-first-service.png);
}
	...
	background-image:
		...
		<table class="tip-table">
			<tr>
				...
				<td class="tip-empty"></td>
				<td class="tip-top contract-first-service"></td>
				<td class="tip-empty "></td>
			...
			<tr>
				...
				<td class="tip-content">
					...
					<%
						...
						%>
						<a class="tip-title"
							href="../ds/uploadWsdl.jsp?region=region1&item=ds_contract_first_menu">Contract
							First Services</a><br />
						 <%
							} else {
						%>
						Contract
							<h3>First Services</h3><br />
								<%
							}
						%>
						<p>Already have schema defined? Start create Data Service
							using contract first approach.</p>
