...
*under the License.
*/
package org.wso2.carbon.localentry.test.general;
...
public class WsdlAsALocalEntryUseInAProxyTestCase extends ESBMediatorTest {
    ...
    @Test(groups = "wso2.esb", description = "- Add a wsdl as a local entry Use that wsdl in a proxy")
    public void testWsdlAsALocalEntryUsedInAProxy() throws Exception {
