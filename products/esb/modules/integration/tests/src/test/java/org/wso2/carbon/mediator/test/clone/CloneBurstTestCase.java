...
public class CloneBurstTestCase extends ESBMediatorTest {
    ...
    @Test(groups = "wso2.esb", description = "Tests message burst")
    public void testBurstMessage() throws Exception, InterruptedException {
