...
public class CloneMediatorAnonymousEndpointsTestCase extends ESBMediatorTest {
	...
	@Test(groups = "wso2.esb", description = "Tests http adress")
	public void testSquence() throws Exception, InterruptedException {
		loadESBConfigurationFromClasspath("/artifacts/ESB/mediatorconfig/clone/clone_unknown_endpoints.xml");
		String response = client.getResponse("http://" + hostName + ":" + nhttpPort, "WSO2");
