...
public class CloneMediatorSequenceTestCase extends ESBMediatorTest {
    ...
    public void testSequence() throws Exception, InterruptedException {
        loadESBConfigurationFromClasspath("/artifacts/ESB/mediatorconfig/clone/clone_sequence.xml");
        URL url =
                getClass().getResource("/artifacts/ESB/mediatorconfig/clone/cloneLogAndSendSequence.xml");
