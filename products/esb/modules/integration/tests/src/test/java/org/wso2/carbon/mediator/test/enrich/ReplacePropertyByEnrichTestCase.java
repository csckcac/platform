...
public class ReplacePropertyByEnrichTestCase extends ESBMediatorTest {
    ...
    public void test() throws AxisFault {
        ...
        OMElement response = axis2Client.sendSimpleStockQuoteRequest(getProxyServiceURL("enrichSample2"), "http://localhost:9000/services/SimpleStockQuoteService", "IBM");


        Assert.assertTrue(response.toString().contains("WSO2 Company"), "Symbol Name mismatched");
        Assert.assertTrue(response.toString().contains("<ax21:symbol>WSO2</ax21:symbol>"), "Symbol Name mismatched");
