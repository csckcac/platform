 ...
 * under the License.
 */
package org.wso2.carbon.mediator.test.out;
...
public class OutMediatorWithoutChildElementTestCase extends ESBMediatorTest {
    ...
    public void testOutWithoutChildren() throws Exception {
        ...
        try {
            ...
            assertTrue("Evaluate Read Timed out Exception", e.getReason().contains("Read timed out"));
        }
    }
