...
public class SequenceWhichHasJsFunctionsForBothInOutTestCase extends ESBMediatorTest {
    ...
    @Test(groups = "wso2.esb", description = "Invoke a sequence which has inlined js functions for both 'in' and 'out' flows")
