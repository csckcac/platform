...
public class SendMediatorEndpointAtConfigRegistryTestCase extends ESBMediatorTest {
    ...
    public void endPointFromConfigRegistryTest() throws Exception {
        ...
        assertEquals(symbolResponse,"IBM","Symbol is not macth");
    }
    ...
    private void uploadResourcesToConfigRegistry() throws Exception {
        ...
        resourceAdminServiceStub.addResource(
                ...
                new DataHandler(new URL("file:///" + getClass().getResource(
                        "/artifacts/ESB/synapseconfig/send_mediator/endpoints/registry_endpoint.xml").getPath())));
        Thread.sleep(1000);
    }
