...
public class InvalidPrefixTestCase extends ESBMediatorTest {
    ...
    @Test(groups = {"wso2.esb"}, description = "Negative Case 2: Invalid prefix")
        ...
        try {
            response =
                    axis2Client.sendSimpleStockQuoteRequest(getMainSequenceURL(),
                                                            ...
                                                            "IBM");
            fail("This Request should throw AxisFault");
        } catch (AxisFault e) {
            assertTrue("Error Message mismatched", e.getReason().contains("The input stream for an incoming message is null"));
        }
    }
