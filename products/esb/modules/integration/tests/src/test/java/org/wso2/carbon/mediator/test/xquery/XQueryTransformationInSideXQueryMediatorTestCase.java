...
*under the License.
*/
package org.wso2.carbon.mediator.test.xquery;
...
public class XQueryTransformationInSideXQueryMediatorTestCase extends ESBMediatorTest {
    ...
    public void testXQueryTransformation() throws Exception {
