...
if not exist "%CARBON_HOME%\repository\lib\org.wso2.carbon.registry.core-*.jar" goto noAntRan
goto skipnoAntRan

:noAntRan
echo You have to run 'ant' command inside the "%CARBON_HOME%\bin" before running the checkin client.
goto end
