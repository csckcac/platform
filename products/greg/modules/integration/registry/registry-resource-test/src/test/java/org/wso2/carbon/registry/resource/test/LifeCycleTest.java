...
public class LifeCycleTest extends TestTemplate {
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            LifeCycleManagementServiceStub lifeCycleManagementServiceStub = TestUtils.getLifeCycleManagementServiceStub(sessionCookie);
            ...
            collectionPath = resourceAdminServiceStub.addCollection("/TestAutomation", "LifeCycleTest", "", "");
            log.info("collection added to " + collectionPath);
