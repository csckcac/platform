...
public class CommentTest extends TestSetup {
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            e.printStackTrace();
            fail("The Comments Test for WS-API failed");
        }
    ...
    private void addCommentToResource() throws Exception {
        Resource r1 = registry.newResource();
        byte[] r1content = "R1 content".getBytes();
        r1.setContent(r1content);
...
//                //System.out.println(comment.getTime());
    ...
    private void addCommentToCollection() throws Exception {
...
/*try {
   ...
   fail("Failed to delete test resources.");
    ...
    private void addCommenttoRoot() throws Exception {
...
/*try {
   ...
   fail("Failed to delete test resources.");
    ...
    private void editComment() throws Exception {
        Resource r1 = registry.newResource();
        byte[] r1content = "R1 content".getBytes();
        r1.setContent(r1content);
...
//                //System.out.println("\n");
    ...
    private void commentDelete() throws Exception {
