...
public class PropertiesTest extends TestSetup {
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            e.printStackTrace();
            fail("The Properties Test for WS-API failed");
        }
    }

    private void rootLevelProperties() throws Exception {
    ...
    private void singleValuedProperties() throws Exception {
    ...
    private void multiValuedProperties() throws Exception {
    ...
    private void removingProperties() throws Exception {
    ...
    private void removingMultivaluedProperties() throws Exception {
    ...
    private void editingMultivaluedProperties() throws Exception {
