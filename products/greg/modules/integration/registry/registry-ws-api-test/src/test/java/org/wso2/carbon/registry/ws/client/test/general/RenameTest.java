...
public class RenameTest extends TestSetup {
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            e.printStackTrace();
            fail("The Rename Test for WS-API failed");
        }
    }

    private void rootLevelResourceRename() throws Exception {
    ...
    private void generalResourceRename() throws Exception {
    ...
    private void rootLevelCollectionRename() throws Exception {
    ...
    private void generalCollectionRename() throws Exception {
