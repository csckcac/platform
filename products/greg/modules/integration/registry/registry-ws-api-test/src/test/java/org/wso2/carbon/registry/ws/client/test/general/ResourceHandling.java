...
public class ResourceHandling extends TestSetup {
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            e.printStackTrace();
            fail("The Resource Handling Test for WS-API failed");
        }
    }

    private void newCollection() throws Exception {
    ...
    private void resourceCopy() throws Exception {
...
//            assertEquals("Authour name is not exist", r1.getAuthorUserName(), r2.getAuthorUserName());
    ...
    private void collectionCopy() throws Exception {
...
//            assertEquals("Author Name is not copied", r1.getAuthorUserName(), r2.getAuthorUserName());
    ...
    private void getResourceoperation() throws Exception {
...
//        assertTrue("Permenent path contanin the string" + path + " verion", st.contains("/testk/testa/derby.log;version:"));
    ...
    private void getCollectionoperation() throws Exception {
