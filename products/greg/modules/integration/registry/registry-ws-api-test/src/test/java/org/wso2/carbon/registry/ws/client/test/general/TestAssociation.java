...
public void runSuccessCase() {
    ...
    try {
        ...
        e.printStackTrace();
        fail("The Association Test for WS-API failed");
    }
}

    private void addAssociationToResource() throws Exception {
    ...
    private void addAssociationToCollection() throws Exception {
    ...
    private void addAssociationToRoot() throws Exception {
    ...
    private void getResourceAssociation() throws Exception {
    ...
    private void getCollectionAssociation() throws Exception {
...
//    }
    ...
    private void removeResourceAssociation() throws Exception {
    ...
    private void removeCollectionAssociation() throws Exception {
