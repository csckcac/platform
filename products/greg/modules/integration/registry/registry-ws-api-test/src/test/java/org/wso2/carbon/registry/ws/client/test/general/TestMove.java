...
public class TestMove extends TestSetup {
    ...
    public void runSuccessCase() {
        ...
        try {
            ...
            e.printStackTrace();
            fail("The Move Test for WS-API failed");
        }
    }

    private void resourceMoveFromRoot() throws Exception {
    ...
    private void resourceMoveToRoot() throws Exception {
    ...
    private void generalResourceMove() throws Exception {
    ...
    private void generalCollectionMove() throws Exception {
