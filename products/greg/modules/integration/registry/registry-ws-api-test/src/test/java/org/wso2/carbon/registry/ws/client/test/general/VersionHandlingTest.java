...
/*        try {
            ...
            e.printStackTrace();
            fail("The Version Handling Test for WS-API failed");
        }*/
    ...
    private void createVersions() throws Exception {
    ...
    private void resourceContentVersioning() throws Exception {
    ...
    private void resourcePropertyVersioning() throws Exception {
    ...
    private void simpleCollectionVersioning() throws Exception {
    ...
    private void testGetContentOfOldData() throws Exception {
