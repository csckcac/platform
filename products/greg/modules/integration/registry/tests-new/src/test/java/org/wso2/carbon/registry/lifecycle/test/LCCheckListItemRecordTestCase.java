...
public class LCCheckListItemRecordTestCase {
    ...
    public void testVerifyAuditDevCheck() throws Exception {
        ...
        assertEquals(getAuditRecords(auditPath, 2, USER, false, false), userInfo.getUserName(), "User is not testuser1");
        ...
        assertEquals(getAuditRecords(auditPath, 1, USER, false, false), userInfo.getUserName(), "User is not testuser1");
        ...
        assertEquals(getAuditRecords(auditPath, 0, USER, false, false), userInfo.getUserName(), "User is not testuser1");
