...
public class RegistrySearchMediaType {
    ...
    public void init() throws Exception {
        ...
        WSRegistryServiceClient wsRegistry = registryProviderUtil.getWSRegistry(userId, ProductConstant.GREG_SERVER_NAME);
    ...
    public void searchWSDLSymLinkMediaType()
        ...
        resourceAdminServiceClient.addWSDL("desc", dh);
