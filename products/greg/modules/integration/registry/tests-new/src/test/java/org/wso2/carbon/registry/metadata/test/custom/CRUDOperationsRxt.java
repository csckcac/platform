...
public class CRUDOperationsRxt {
    ...
    public void testRxtUpload()
        ...
        AuthenticatorClient authenticatorClient = new AuthenticatorClient("https://localhost:9443/services/");
    ...
    public void testRxtArtifact()
        ...
        if (result) {
            ...
            options.setTo(new EndpointReference("https://localhost:9443/services/Person"));
