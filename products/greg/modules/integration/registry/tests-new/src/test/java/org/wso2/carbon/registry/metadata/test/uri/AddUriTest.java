...
public class AddUriTest {
    ...
    public void testUri() throws RegistryException, FileNotFoundException, InterruptedException {
        ...
        artifactWsdl.setAttribute("overview_uri", "https://svn.wso2.org/repos/wso2/carbon/platform/trunk/" +
                                                  "platform-integration/clarity-tests/org.wso2.carbon.automation.test.repo/src/main/resources/artifacts/GREG/wsdl/AmazonWebServices.wsdl");
        ...
        assertTrue(artifactWsdl.getAttribute("overview_uri").equals("https://svn.wso2.org/repos/wso2/carbon/platform/trunk/" +
                                                                    "platform-integration/clarity-tests/org.wso2.carbon.automation.test.repo/src/main/resources/artifacts/GREG/" +
        ...
        artifactSchema.setAttribute("overview_uri", "https://svn.wso2.org/repos/wso2/carbon/platform/trunk/" +
                                                    "platform-integration/clarity-tests/org.wso2.carbon.automation.test.repo/src/main/resources/artifacts/GREG/xsd/purchasing.xsd");
        ...
        artifactPolicy.setAttribute("overview_uri", "https://svn.wso2.org/repos/wso2/carbon/platform/trunk/" +
                                                    "platform-integration/clarity-tests/org.wso2.carbon.automation.test.repo/src/main/resources/artifacts/GREG/policy/policy.xml");
        ...
        artifactGeneric.setAttribute("overview_uri", "https://svn.wso2.org/repos/wso2/carbon/platform/trunk/" +
                                                     "platform-integration/clarity-tests/org.wso2.carbon.automation.test.repo/src/main/resources/artifacts/GREG/resource.txt");
    ...
    public void testUriSchemaWithSchema() throws RegistryException, FileNotFoundException {
        ...
        artifactSchemaWithSchema.setAttribute("overview_uri", "https://svn.wso2.org/repos/wso2/carbon/platform/trunk/" +
                                                              "platform-integration/clarity-tests/org.wso2.carbon.automation.test.repo/src/main/resources/artifacts/GREG/schema/SchemaImportSample.xsd");
        ...
        assertTrue(artifactSchemaWithSchema.getAttribute("overview_uri").equals("https://svn.wso2.org/repos/wso2/carbon/" +
                                                                                "platform/trunk/platform-integration/clarity-tests/org.wso2.carbon.automation.test.repo/src/main/resources/artifacts/" +
                                                                                "GREG/schema/SchemaImportSample.xsd"), "artifact URI not found");
    ...
    @Test(groups = "wso2.greg", description = "Test invalid URIs", dependsOnMethods = "testUriSchemaWithSchema", expectedExceptions = RegistryException.class)
    public void testInvalidUriWsdl() throws RegistryException, FileNotFoundException {
        ...
        artifact.setAttribute("overview_uri", "https://svn.wso2.org/repos/wso2/carbon/platform/trunk/" +
                                              "platform-integration/clarity-tests/org.wso2.carbon.automation.test.repo/src/main/resources/artifacts/GREG/wsdl/AutomatedInvalidWSDL.wsdl");
    ...
    @Test(groups = "wso2.greg", description = "Test invalid URIs", dependsOnMethods = "testInvalidUriWsdl", expectedExceptions = RegistryException.class)
    public void testInvalidUriSchema() throws RegistryException, FileNotFoundException {
        ...
        artifact.setAttribute("overview_uri", "https://svn.wso2.org/repos/wso2/carbon/platform/trunk/" +
                                              "platform-integration/clarity-tests/org.wso2.carbon.automation.test.repo/src/main/resources/artifacts/GREG/schema/XmlInvalidSchema.xsd");
    ...
    @Test(groups = "wso2.greg", description = "Test invalid URIs", dependsOnMethods = "testInvalidUriSchema", expectedExceptions = RegistryException.class)
    public void testInvalidUriPolicy() throws RegistryException, FileNotFoundException {
        ...
        artifact.setAttribute("overview_uri", "https://svn.wso2.org/repos/wso2/carbon/platform/trunk/" +
                                              "platform-integration/clarity-tests/org.wso2.carbon.automation.test.repo/src/main/resources/artifacts/GREG/policy/invlidPolicy.xml");
    ...
    public void testNonExistingUrl() throws RegistryException, FileNotFoundException {
        ...
        artifact.setAttribute("overview_uri", "https://svn.wso2.org/repos/wso2/carbon/platform/trunk/" +
                                              "platform-integration/clarity-tests/org.wso2.carbon.automation.test.repo/src/main/resources/artifacts/wsdl/AmazonWebServices.wsdl");
        artifact.setAttribute("overview_type", "WSDL");
        artifactManager.addGenericArtifact(artifact);
