...
public class CyclicWSDLAddTestCaseNew {
     ...
     */
    @Test(groups = "wso2.greg", description = "Add Cyclic WSDL")
    public void testAddCyclicWSDL() throws RemoteException,
                                           ResourceAdminServiceExceptionException,
                                           GovernanceException,
                                           MalformedURLException {

        WsdlManager wsdlManager = new WsdlManager(governanceRegistry);
        Wsdl wsdl = wsdlManager.newWsdl("https://svn.wso2.org/repos/wso2/carbon/" +
        ...
        wsdl.addAttribute("description", "added cyclic wsdl via URL");
