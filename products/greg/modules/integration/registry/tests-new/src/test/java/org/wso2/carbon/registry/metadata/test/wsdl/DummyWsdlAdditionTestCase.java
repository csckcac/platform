...
public class DummyWsdlAdditionTestCase {
	...
	/**
	 * added an .rxt file as the dummy wsdl:verified the expection using the
	 * expectedException
	 */
	@Test(groups = "wso2.greg", description = "a .rxt file is given as the dummy wsdl", enabled = true, expectedExceptions = GovernanceException.class)
