...
public class RMWsdlADDTestCaseNew {
     ...
     *
     */
    @Test(groups = "wso2.greg", description = "Add RM service WSDL")
    public void testAddRMWSDL() throws RemoteException,
                                       ResourceAdminServiceExceptionException, GovernanceException,
                                       MalformedURLException {

        WsdlManager wsdlManager = new WsdlManager(governanceRegistry);
        Wsdl wsdl = wsdlManager.newWsdl("http://www.restfulwebservices.net/wcf/WeatherForecastService.svc?wsdl");
        wsdl.addAttribute("version", "1.0.0");
        wsdl.addAttribute("author", "Aparna");
        wsdl.addAttribute("description", "added wsdl with RM service via URL");
        wsdlManager.addWsdl(wsdl);
        assertTrue(wsdl.getAttribute("description").contentEquals("added wsdl with RM service via URL"));
    }
}
