...
public class SecuredUrlWsdlAddTestCase {
    ...
    public void testAddSecuredURLWSDL() throws RemoteException,
        ...
        Wsdl wsdl = wsdlManager.newWsdl("https://svn.wso2.org/repos/wso2/carbon/platform/trunk/" +
                                        ...
                                        "/src/main/resources/artifacts/GREG/wsdl/IClinicalNotes.wsdl");
        wsdl.addAttribute("version", "1.0.0");
        wsdl.addAttribute("author", "Aparna");
        wsdl.addAttribute("description", "added secured URL wsdl");
        wsdlManager.addWsdl(wsdl);
        assertTrue(wsdl.getAttribute("description").contentEquals("added secured URL wsdl"));
    }
}
