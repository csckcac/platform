...
public class CollectionInCollectionFeedTestCase {
    ...
    public void testCopyCollection()
        ...
        //copy resource
        resourceAdminClient.copyResource(PATH, PATH+COLL_NAME_AFTER_RENAME, COLL_COPIED_LOCATION, COLL_NAME_AFTER_COPYING);
    ...
    @Test(dependsOnMethods = "testMoveCollection", enabled = true)
