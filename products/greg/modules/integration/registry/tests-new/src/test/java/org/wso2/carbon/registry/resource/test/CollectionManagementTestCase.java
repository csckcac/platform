...
public class CollectionManagementTestCase {
    ...
    @Test
    public void testAddCollection() throws ResourceAdminServiceExceptionException, RemoteException, InterruptedException {
    ...
    @Test(dependsOnMethods = "testAddCollection", enabled = true)
    ...
    @Test(dependsOnMethods = "testRenameCollection", enabled = true)
    ...
    @Test(dependsOnMethods = "testCopyCollection")
    public void testFeedAfterCopying() throws ResourceAdminServiceExceptionException, RemoteException {
    ...
    @Test(dependsOnMethods = "testMoveCollection")
    public void testFeedAfterMoving() throws ResourceAdminServiceExceptionException, RemoteException {
