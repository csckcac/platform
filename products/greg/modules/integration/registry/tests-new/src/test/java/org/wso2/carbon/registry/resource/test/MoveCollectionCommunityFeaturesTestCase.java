...
public class MoveCollectionCommunityFeaturesTestCase {
    ...
    public void testAddCollection()
        ...
        assertTrue(userInfo.getUserName().equalsIgnoreCase(authorUserName), "Collection creation failure");
    }

    @Test(dependsOnMethods = "testAddCollection")
    ...
    @Test(dependsOnMethods = "testAddCommentToCollection")
    ...
    public void testMoveCollection() throws ResourceAdminServiceExceptionException, RemoteException {
    ...
    @Test(dependsOnMethods = "testMoveCollection",description = "Checks the dependencies after copying the collection")
