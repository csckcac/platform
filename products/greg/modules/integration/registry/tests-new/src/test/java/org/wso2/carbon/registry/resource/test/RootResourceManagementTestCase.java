...
public class RootResourceManagementTestCase {
    ...
    @Test(dependsOnMethods = "testAddResourceToRoot", enabled = true)
    ...
    @Test(dependsOnMethods = "testRenameRootResource", enabled = true)
    ...
    @Test(dependsOnMethods = "testCopyRootResource", enabled = true)
    ...
    @Test(dependsOnMethods = "testMoveRootResource", enabled = true)
