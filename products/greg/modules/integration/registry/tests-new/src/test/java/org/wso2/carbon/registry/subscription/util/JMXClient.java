...
public class JMXClient implements NotificationListener {
    ...
    public void connect(String userName, String password) throws Exception {
        try {
            JMXServiceURL url = new JMXServiceURL("service:jmx:rmi://" + NetworkUtils.getLocalHostname() + ":" + RMIServerPort + "/jndi/rmi://" + NetworkUtils.getLocalHostname() + ":" + RMIRegistryPort + "/jmxrmi");
