...
public class GenericGovernanceArtifactTestCase {
    ...
    @Test(groups = {"wso2.greg"}, description = "add new rxt file", priority = 2, enabled = true)
    ...
    @Test(groups = {"wso2.greg"}, description = "add new rxt file", priority = 3, enabled = true)
    ...
    @Test(groups = {"wso2.greg"}, description = "add new rxt file", priority = 4, enabled = true)
    ...
    @Test(groups = {"wso2.greg"}, description = "Get LC state and LC name", priority = 8, enabled = true)
