...
public class SchemaClientTestCase{
    ...
    public void testAddSchemaFromContent() throws Exception {
        ...
        byte[] bytes = null;
        try {
            InputStream inputStream = new URL("http://svn.wso2.org/repos/wso2/carbon/platform/trunk/" +
                                              "products/greg/modules/integration/registry/tests/src/test/java" +
                                              "/resources/xsd/purchasing.xsd").openStream();
            try {
    ...
    public void testAddSchemaFromContentNoName() throws Exception {
        ...
        try {
            InputStream inputStream = new URL("http://svn.wso2.org/repos/wso2/carbon/platform/trunk" +
                                              "/products/greg/modules/integration/registry/tests" +
                                              "/src/test/java/resources/xsd/purchasing.xsd").openStream();
            try {
                bytes = IOUtils.toByteArray(inputStream);
            } finally {
                inputStream.close();
    ...
    public void testInvalidSchema() {
        ...
        try {
            schema = schemaManager.newSchema("http://svn.wso2.org/repos/wso2/carbon/platform/trunk/products/" +
                                             "greg/modules/integration/registry/tests/src/test/java/resources" +
    ...
    public void testSchemaImport() throws GovernanceException {
        ...
        Schema schema;
        try {
            schema = schemaManager.newSchema("http://svn.wso2.org/repos/wso2/carbon/platform/trunk/" +
                                             "products/greg/modules/integration/registry/tests/src/" +
                                             "test/java/resources/schema/SchemaImportSample.xsd");
            schemaManager.addSchema(schema);
        } catch (GovernanceException e) {
    ...
    public void testAddDuplicateSchema() throws GovernanceException {
        ...
        schema = schemaManager.newSchema("http://svn.wso2.org/repos/wso2/carbon/platform/trunk/products" +
                                         "/greg/modules/integration/registry/tests/src/test/java/" +
                                         "resources/schema/SchemaImportSample.xsd");
        schemaManager.addSchema(schema);
        try {
            schemaManager.addSchema(schema);
        } catch (GovernanceException e) {
