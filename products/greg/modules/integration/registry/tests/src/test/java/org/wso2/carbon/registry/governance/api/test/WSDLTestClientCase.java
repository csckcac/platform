...
public class WSDLTestClientCase {
    ...
    public void testAddWSDL() throws Exception {
        ...
        Wsdl wsdl = wsdlManager.newWsdl("http://svn.wso2.org/repos/wso2/carbon/platform/trunk/products" +
                                        "/greg/modules/integration/registry/tests/src/test/java/resources/wsdl/BizService.wsdl");
        ...
        // add again
        Wsdl anotherWsdl = wsdlManager.newWsdl("http://svn.wso2.org/repos/wso2/carbon/platform/trunk/" +
                                               "products/greg/modules/integration/registry/tests/src/" +
                                               "test/java/resources/wsdl/BizService.wsdl");
    ...
    public void testAddWsdWithPolicyImport() throws GovernanceException {
        String wsdlLocation = "http://svn.wso2.org/repos/wso2/carbon/platform/trunk/products/greg/" +
                              "modules/integration/registry/tests/src/test/java/resources/wsdl/" +
    ...
    public void testWsdlWithInlinePolicyAndSchema() throws GovernanceException {
        ...
        Wsdl wsdl;
        try {
            wsdl = wsdlManager.newWsdl("http://svn.wso2.org/repos/wso2/carbon/platform/trunk/products/" +
                                       "greg/modules/integration/registry/tests/src/test/java/resources/wsdl" +
                                       "/WithInlinePolicyAndSchema.wsdl");
            wsdlManager.addWsdl(wsdl);
        } catch (GovernanceException e) {
