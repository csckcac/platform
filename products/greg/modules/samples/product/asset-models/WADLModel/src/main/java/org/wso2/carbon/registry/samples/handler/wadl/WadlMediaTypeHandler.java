...
package org.wso2.carbon.registry.samples.handler.wadl;
...
import org.wso2.carbon.registry.samples.handler.wadl.utils.ResourceProcessor;
import org.wso2.carbon.registry.samples.handler.wadl.utils.WadlConstants;
import org.wso2.carbon.registry.samples.handler.wadl.utils.WadlUtils;
...
public class WadlMediaTypeHandler extends Handler {
    ...
    public void put(RequestContext requestContext) throws RegistryException{
        if (!WadlUtils.isUpdateLockAvailable()) {
            return;
        }
        WadlUtils.acquireUpdateLock();
    ...
    private String saveEndpoint(String url) throws RegistryException {
        ...
        String endpointAbsoluteBasePath = RegistryUtils.getAbsolutePath(registry.getRegistryContext(),
                org.wso2.carbon.registry.core.RegistryConstants.GOVERNANCE_REGISTRY_BASE_PATH +
                        WadlConstants.ENDPOINT_DEFAULT_LOCATION);
    ...
    private String saveEndpointValues(String url, String endpointAbsolutePath) throws RegistryException {
        ...
        resource.setProperty(CommonConstants.ARTIFACT_ID_PROP_KEY, UUID.randomUUID().toString());
