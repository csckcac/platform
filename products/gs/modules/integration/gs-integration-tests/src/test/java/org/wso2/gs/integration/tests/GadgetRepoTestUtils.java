...
/*
GS- GadgetRepoTestUtils - Gadget Repository
*/

public class GadgetRepoTestUtils {
    private static final Log log = LogFactory.getLog(GadgetRepoTestUtils.class);
    ...
    // get the gadgetRepoServiceStub
    public static GadgetRepoServiceStub getGadgetRepoServiceStub(String sessionCookie) {
        String serviceURL = null;
        serviceURL = FrameworkSettings.SERVICE_URL + "GadgetRepoService";
        GadgetRepoServiceStub gadgetRepoServiceStub = null;
        try {
            gadgetRepoServiceStub = new GadgetRepoServiceStub(serviceURL);
