...
<head>
    ...
    <title>WSO2 Stratos Gadget Server</title>
    ...
    <link rel="stylesheet" type="text/css" href="../tenant-login/css/loginpage.css"/>
		...
		<div id="login-content">
			    ...
			    `                                   <tr>
										...
										%>
										<tr>
			                                                            <td colspan="2"><a class="help" target="_blank" href="../tenant-login/docs/userguide.html" tabindex="4"><fmt:message key="sign.in.help"/></a></td>
			                                                        </tr>
			                                                    </table>
				...
				<div id="footer">
					<div class="powered">
						<span>Powered by</span><a target="_blank" href="http://wso2.org/projects/gs"><img src="../tenant-login/images/powered.gif"/></a>
					</div>
