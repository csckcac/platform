...
<style type="text/css">
 ...
 <h2 class="dashboard-title">WSO2 Hosting Server quick start dashboard</h2>
            ...
            <tr>
                <td class="tip-content">
                    <div class="tip-content-lifter">
						...
						%>
                        <p>PHP web applications can be deployed in Hosting Server. All configurations such as QoS can be easily configured here.</p>
                ...
                <td class="tip-content">
                    <div class="tip-content-lifter">
						...
						%>
                        <a class="tip-title" href="../hosting-mgt/index.jsp?region=region1&item=webapps_list_menu">PHP Web Applications</a> <br />
						<%
							} else {
						%>
				      <h3>PHP Web Applications</h3> <br />
				        <%
							}
						%>
                        <p>PHP Web Application hosting features in Hosting supports deployment of PHP Webapps. Deployed Webapps can be easily managed using the Webapp management facilities available in the management console.</p>
                ...
                <td class="tip-content">
                    <div class="tip-content-lifter">
                       ...
                       <h3>Service Testing</h3> <br/>
						...
						%>
                        <p>Tryit tool can be used as a simple PHP Web Service client which can be used to try your services within Hosting itself.</p>
            ...
            <tr>
                <td class="tip-content">
                    <div class="tip-content-lifter">
						...
						%>
                        <p>Use WSDL2Java tool in PHP Web Application Server to convert Web Service WSDL to a set of Java objects.</p>
                ...
                <td class="tip-content">
                    <div class="tip-content-lifter">
						...
						%>
                        <p>Use Java2WSDL tool in PHP Web Application Server  make it easy to develop a new web service.</p>
                ...
                <td class="tip-content">
                    <div class="tip-content-lifter">
                      <%
						...
						%>
                        <p>Use WSDL Validator tool in PHP Web Application Server to Validate WSDL by directly uploading them or providing a URL.</p>
