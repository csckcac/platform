    ...
    `                                   <tr>
                                            <td class="user_pass_td">
                                                ...
                                                <form action='../admin/login_action.jsp' method="POST"
                                                    ...
                                                    <input type="hidden" id="txtbackendURL"
                                                           name="backendURL" class="user" tabindex="1"
                                                           value="<%=backendURL%>"/>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" id="txtUserName"
                                                                                   name="username"
                                                                                   tabindex="1"/><%=tenantdomain%>  <div class="help_txt"><%=tip%></div></td>
                                                    </tr>
                                                    <tr>
                                                        <td><label for="txtPassword"><fmt:message
                                                                                key="password"/></label>:</td><td><input type="password" id="txtPassword"
                                                                                   name="password" tabindex="2"/> </td>
                                                    </tr>
                                                    <tr>
                                                        <td></td><td><input type="submit"
                                                                                   value="<fmt:message key="sign.in"/>"
                                                                                   tabindex="3" class="button" style="float:left;background-image:none" /> </td>
                                                    </tr>
                                                        <%
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                ...
                                                                account, please <a href="<%=registerPath%>"
                                                    ...
                                                    <a class="help" target="_blank" href="../tenant-login/docs/userguide.html" tabindex="4"><fmt:message key="sign.in.help"/></a>
				...
				<div id="footer">
					<div class="powered">
						<span>Powered by</span><a target="_blank" href="http://wso2.org/projects/is"><img src="../tenant-login/images/powered.gif"/></a>
					</div>
