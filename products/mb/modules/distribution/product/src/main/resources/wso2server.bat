...
set CARBON_XBOOTCLASSPATH=
FOR %%C in ("%CARBON_HOME%\lib\xboot\*.jar") DO set CARBON_XBOOTCLASSPATH=!CARBON_XBOOTCLASSPATH!;".\lib\xboot\%%~nC%%~xC"
