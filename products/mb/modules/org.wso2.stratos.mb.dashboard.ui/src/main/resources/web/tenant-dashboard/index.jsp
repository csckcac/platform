...
<div id="workArea">
    ...
    <table class="tip-table">
        ...
        <tr>
            <td class="tip-content">
                <div class="tip-content-lifter">
                    <h3 class="tip-title">SQS support</h3> <br/>

                                   <p> SQS support to store retrieve messages using a web service API.</p>
            ...
            <td class="tip-content">
                <div class="tip-content-lifter">
                    <h3 class="tip-title">Manage message boxes</h3> <br/>


                                        <p>Administrative console support to manage message boxes and store/retrieve messages.</p>
            ...
            <td class="tip-content">
                <div class="tip-content-lifter">
                    <h3 class="tip-title">Message box as event sink</h3> <br/>


                                      <p>Ability to use a message box as the event sink for a subscription.</p>
