 ...
 */
package org.wso2.wsf.sample.clientapi.clients;
...
/**
 * SingleChannelNonBlockingClient
 */
public class SingleChannelNonBlockingClient {
    ...
    public static void run(String epr) {
        try {
            ...
            serviceClient.sendReceiveNonBlocking(ClientUtils
                    .getEchoPayload("Hello, I'm SingleChannelNonBlockingClient"), callback); // Notice the callback!
