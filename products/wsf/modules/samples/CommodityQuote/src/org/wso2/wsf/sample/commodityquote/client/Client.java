...
package org.wso2.wsf.sample.commodityquote.client;
...
public class Client {
    ...
    private static final String wso2appserverHome = System.getProperty("wso2wsf.home");

    // ===========================================================
    private static boolean isMailEPR = false;

    public Client(BufferedReader console, EndpointReference epr) throws Exception {
        String repo = wso2appserverHome + File.separator + "repository";
