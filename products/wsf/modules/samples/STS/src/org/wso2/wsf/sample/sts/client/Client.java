...
* under the License.
*/
package org.wso2.wsf.sample.sts.client;
...
public class Client {
	...
	final static String SERVICE_EPR = "http://localhost:9763/services/HelloService";
        ...
        private static final String wso2wsfHome = System.getProperty("wso2wsf.home");
	...
	public static void main(String[] args) throws Exception {
		...
		ctx = ConfigurationContextFactory.createConfigurationContextFromFileSystem(wso2wsfHome +
		...
		stsPolicy = loadPolicy(wso2wsfHome + "/samples/STS/conf/sts.policy.xml");

		servicePolicy = loadPolicy(wso2wsfHome + "/samples/STS/conf/service.policy.xml");
	...
	private static Policy loadPolicy(String xmlPath) throws Exception {
		...
		keystore = wso2wsfHome + File.separator + "samples" +
