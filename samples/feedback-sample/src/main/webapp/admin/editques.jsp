...
<body>
	...
	<form method="POST" action="../ProcessQuestions">
		...
		<br> <input type="hidden" id="action" name="action" value="edit" />
		<table border="0" cellspacing="5">
			...
			<tr>
				...
				<td align="left"><textarea cols="50" rows="6" id="question"
						name="question">
                    </textarea></td>
			</tr>
			<tr>
				<th align="right">Question Type :</th>
				<td align="left"><select id="qtype" name="qtype">
			...
			<tr>
				<td align="right">&nbsp;</td>
				<td align="left"><input type="submit" value="edit"><input
