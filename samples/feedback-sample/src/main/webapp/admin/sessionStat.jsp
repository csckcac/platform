...
<body>
 ...
 <%
 	...
 	try {
 		...
 		HashMap<Integer, FeedbackResultStat> results = dao
 ...
 %>
		...
		<table align="center" class="tableStyle" border="1">
			<tr>
				<td colspan="8">Feedback statistics</td>
			</tr>
			<tr>
			...
			%>
	            		 	<tr>
							<td width="50%"><b><%=answerCounts.getSession()%></b></td> 
	             		<%
 	             			int count = 0;
		...
		<table align="center" class="tableStyle" border="1">
			<tr>
				<td colspan="3" width="100%">Feedback Comments</td>
			</tr>
			...
			%>
			<tr>
				<td colspan="3" width="100%"><b><%=answerCounts.getSession()%></b>
				</td>
			</tr>
			<%
			...
			%>
			<tr>
				<td colspan="3" width="100%"><%=comments.get(x)%></td>
			</tr>
			<%
				}
						}
